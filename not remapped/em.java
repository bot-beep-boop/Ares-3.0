...
public class em extends ByteBuf {
   ...
   public zx i() throws IOException {
      ...
      if (var2 >= 0) {
         ...
         var1 = new zx(zw.b(var2), var3, var4);
         var1.d(this.h());
      }
   ...
   public void a(dn var1) {
      if (var1 == null) {
         ...
         try {
            dx.a((dn)var1, (DataOutput)(new ByteBufOutputStream(this)));
   ...
   public dn h() throws IOException {
      ...
      if (var2 == 0) {
         ...
         return dx.a((DataInput)(new ByteBufInputStream(this)), (dw)(new dw(2097152L)));
      }
   }
   ...
   public void a(eu var1) throws IOException {
      this.a(eu.a.a(var1));
   }
