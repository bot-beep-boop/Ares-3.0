public class adg {
   ...
   public cj a(int var1, int var2, int var3) {
      return new cj((this.a << 4) + var1, var2, (this.b << 4) + var3);
   }
   ...
   public cj a(int var1) {
      return new cj(this.a(), var1, this.b());
   }
