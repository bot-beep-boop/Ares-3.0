public class asy {
   ...
   public asx a(adq var1, pk var2, pk var3, float var4) {
      return this.a(var1, var2, var3.s, var3.aR().b, var3.u, var4);
   }

   private asx a(pk var1, asv var2, asv var3, float var4) {
      var2.e = 0.0F;
      var2.f = var2.b(var3);
      var2.g = var2.f;
      this.a.a();
   ...
   public asx a(adq var1, pk var2, cj var3, float var4) {
      return this.a(var1, var2, (double)((float)var3.n() + 0.5F), (double)((float)var3.o() + 0.5F), (double)((float)var3.p() + 0.5F), var4);
   }

   private asx a(adq var1, pk var2, double var3, double var5, double var7, float var9) {
      this.a.a();
      this.c.a(var1, var2);
      asv var10 = this.c.a(var2);
      asv var11 = this.c.a(var2, var3, var5, var7);
      asx var12 = this.a(var2, var10, var11, var9);
      this.c.a();
      return var12;
   }

   private asx a(asv var1, asv var2) {
      int var3 = 1;
