...
public class bml {
   ...
   private static void a(BufferedImage var0, int var1, int var2, boolean var3, boolean var4) {
      ...
      for(int var9 = 0; var9 < var5 * var6; var9 += var5 * var7) {
         ...
         a(var8, var12);
         GL11.glTexSubImage2D(3553, 0, var1, var2 + var10, var5, var11, 32993, 33639, d);
      }

   }

   public static int[] a(bni var0, jy var1) throws IOException {
      BufferedImage var2 = a(var0.a(var1).b());
   ...
   private static void a(int var0, int[] var1, int var2, int var3, int var4, int var5, boolean var6, boolean var7, boolean var8) {
      ...
      for(int var10 = 0; var10 < var2 * var3; var10 += var2 * var12) {
         ...
         b(var1, var10, var13);
         GL11.glTexSubImage2D(3553, var0, var4, var5 + var11, var2, var12, 32993, 33639, d);
      }
            ...
            if (var2[var5] != null) {
               ...
               for(int var11 = 0; var11 < var8; ++var11) {
                  for(int var12 = 0; var12 < var9; ++var12) {
                     ...
                     var7[var11 + var12 * var8] = a(var6[var13], var6[var13 + 1], var6[var13 + var10], var6[var13 + 1 + var10], var4);
                  }
               }
   ...
   private static int a(int var0, int var1, int var2, int var3, boolean var4) {
      if (!var4) {
         int var13 = a(var0, var1, var2, var3, 24);
         int var14 = a(var0, var1, var2, var3, 16);
         int var15 = a(var0, var1, var2, var3, 8);
         int var16 = a(var0, var1, var2, var3, 0);
         ...
         for(var9 = 0; var9 < 4; ++var9) {
            if (e[var9] >> 24 != 0) {
               var5 += (float)Math.pow((double)((float)(e[var9] >> 24 & 255) / 255.0F), 2.2D);
               var6 += (float)Math.pow((double)((float)(e[var9] >> 16 & 255) / 255.0F), 2.2D);
               var7 += (float)Math.pow((double)((float)(e[var9] >> 8 & 255) / 255.0F), 2.2D);
               var8 += (float)Math.pow((double)((float)(e[var9] >> 0 & 255) / 255.0F), 2.2D);
            }
         }
