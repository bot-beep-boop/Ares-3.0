...
public class av extends i {
   ...
   public List<String> a(m var1, String[] var2, cj var3) {
      if (var2.length == 2) {
         ...
         return var2.length > 2 && var2.length <= 5 ? a(var2, 2, var3) : null;
      }
   }
   ...
   public void a(m var1, String[] var2) throws bz {
      if (var2.length < 2) {
         throw new cf(this.c(var1), new Object[0]);
      } else {
         byte var3 = 0;
         int var31 = var3 + 1;
         String var4 = var2[var3];
         lf var5 = a(var1, var2[var31++]);
         aui var6 = var1.d();
         double var7 = var6.a;
         ...
         if (var21 > var19) {
            if (var17 <= 0.0D) {
               throw new bz("commands.playsound.playerTooFar", new Object[]{var5.e_()});
            }
         ...
         var5.a.a((ff)(new gs(var4, var7, var9, var11, (float)var13, (float)var15)));
