...
public class boh extends bnv<bog> {
   ...
   public bog a(JsonElement var1, Type var2, JsonDeserializationContext var3) throws JsonParseException {
      ...
      do {
         ...
         JsonObject var9 = ni.l((JsonElement)var7.getValue(), "language");
         var10 = ni.h(var9, "region");
         var11 = ni.h(var9, "name");
         var12 = ni.a(var9, "bidirectional", false);
         if (var10.isEmpty()) {
      ...
      } while(var5.add(new bnr(var8, var10, var11, var12)));
