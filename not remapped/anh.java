...
public class anh {
   ...
   public DataOutputStream b(int var1, int var2) {
      return this.d(var1, var2) ? null : new DataOutputStream(new DeflaterOutputStream(new anh.a(this, var1, var2)));
   }
      ...
      try {
         ...
         if (var6 != 0 && var7 == var8) {
            ...
            for(var9 = 0; var9 < var7; ++var9) {
               this.f.set(var6 + var9, true);
            }

            var9 = this.f.indexOf(true);
            int var10 = 0;
            int var11;
            if (var9 != -1) {
               for(var11 = var9; var11 < this.f.size(); ++var11) {
                  if (var10 != 0) {
                     if ((Boolean)this.f.get(var11)) {
                        ++var10;
                     } else {
                        var10 = 0;
                     }
                  } else if ((Boolean)this.f.get(var11)) {
                     var9 = var11;
                     var10 = 1;
                  }
   ...
   class a extends ByteArrayOutputStream {
      ...
      public a(anh var1, int var2, int var3) {
         super(8096);
         this.a = var1;
         this.b = var2;
         this.c = var3;
