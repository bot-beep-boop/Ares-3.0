public class asq extends ase {
   ...
   public int[] a(int var1, int var2, int var3, int var4) {
      ...
      int var10 = var7 - 1 << 2;
      int var11 = var8 - 1 << 2;
      int[] var12 = asc.a(var10 * var11);

      int var14;
      for(int var13 = 0; var13 < var8 - 1; ++var13) {
         var14 = 0;
         int var15 = var9[var14 + var13 * var7];

         for(int var16 = var9[var14 + (var13 + 1) * var7]; var14 < var7 - 1; ++var14) {
            double var17 = 3.6D;
            this.a((long)(var14 + var5 << 2), (long)(var13 + var6 << 2));
            double var19 = ((double)this.a(1024) / 1024.0D - 0.5D) * 3.6D;
            double var21 = ((double)this.a(1024) / 1024.0D - 0.5D) * 3.6D;
            this.a((long)(var14 + var5 + 1 << 2), (long)(var13 + var6 << 2));
            double var23 = ((double)this.a(1024) / 1024.0D - 0.5D) * 3.6D + 4.0D;
            double var25 = ((double)this.a(1024) / 1024.0D - 0.5D) * 3.6D;
            this.a((long)(var14 + var5 << 2), (long)(var13 + var6 + 1 << 2));
            double var27 = ((double)this.a(1024) / 1024.0D - 0.5D) * 3.6D;
            double var29 = ((double)this.a(1024) / 1024.0D - 0.5D) * 3.6D + 4.0D;
            this.a((long)(var14 + var5 + 1 << 2), (long)(var13 + var6 + 1 << 2));
            double var31 = ((double)this.a(1024) / 1024.0D - 0.5D) * 3.6D + 4.0D;
            double var33 = ((double)this.a(1024) / 1024.0D - 0.5D) * 3.6D + 4.0D;
            int var35 = var9[var14 + 1 + var13 * var7] & 255;
