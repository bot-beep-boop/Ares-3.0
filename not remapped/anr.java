...
public class anr extends any {
   ...
   protected void a(long var1, int var3, int var4, ans var5, double var6, double var8, double var10, float var12, float var13, float var14, int var15, int var16, double var17) {
      ...
      for(; var15 < var16; ++var15) {
         double var54 = 1.5D + (double)(ns.a((float)var15 * 3.1415927F / (float)var16) * var12 * 1.0F);
         double var30 = var54 * var17;
         var54 *= (double)var19.nextFloat() * 0.25D + 0.75D;
         var30 *= (double)var19.nextFloat() * 0.25D + 0.75D;
         float var32 = ns.b(var14);
         float var33 = ns.a(var14);
         var6 += (double)(ns.b(var13) * var32);
         var8 += (double)var33;
         var10 += (double)(ns.a(var13) * var32);
         var14 *= 0.7F;
         var14 += var25 * 0.05F;
         var13 += var24 * 0.05F;
         var25 *= 0.8F;
         ...
         if (var53 || var19.nextInt(4) != 0) {
            ...
            if (!(var6 < var20 - 16.0D - var54 * 2.0D) && !(var10 < var22 - 16.0D - var54 * 2.0D) && !(var6 > var20 + 16.0D + var54 * 2.0D) && !(var10 > var22 + 16.0D + var54 * 2.0D)) {
               int var55 = ns.c(var6 - var54) - var3 * 16 - 1;
               int var35 = ns.c(var6 + var54) - var3 * 16 + 1;
               int var56 = ns.c(var8 - var30) - 1;
               int var37 = ns.c(var8 + var30) + 1;
               int var57 = ns.c(var10 - var54) - var4 * 16 - 1;
               int var39 = ns.c(var10 + var54) - var4 * 16 + 1;
               if (var55 < 0) {
                  var55 = 0;
               }
                  ...
                  for(var42 = var57; !var58 && var42 < var39; ++var42) {
                     for(int var43 = var37 + 1; !var58 && var43 >= var56 - 1; --var43) {
                        if (var43 >= 0 && var43 < 256) {
                           alz var44 = var5.a(var41, var43, var42);
                           if (var44.c() == afi.i || var44.c() == afi.j) {
                              var58 = true;
                           }
                        ...
                        if (var60 * var60 + var46 * var46 < 1.0D) {
                           for(int var49 = var37; var49 > var56; --var49) {
                              ...
                              if ((var60 * var60 + var46 * var46) * (double)this.d[var49 - 1] + var50 * var50 / 6.0D < 1.0D) {
                                 alz var52 = var5.a(var42, var49, var45);
                                 if (var52.c() == afi.c) {
                                    var48 = true;
                                 }

                                 if (var52.c() == afi.b || var52.c() == afi.d || var52.c() == afi.c) {
                                    if (var49 - 1 < 10) {
                                       var5.a(var42, var49, var45, afi.k.Q());
                                    } else {
                                       var5.a(var42, var49, var45, afi.a.Q());
                                       if (var48 && var5.a(var42, var49 - 1, var45).c() == afi.d) {
                                          var59.c(var42 + var3 * 16, 0, var45 + var4 * 16);
                                          var5.a(var42, var49 - 1, var45, this.c.b((cj)var59).ak);
                                       }
                                    }
                                 }
                              }
