...
public class ShadowUtils {
   public static Iterator<RenderChunk> makeShadowChunkIterator(WorldClient var0, double var1, Entity var3, int var4, ViewFrustum var5) {
      ...
      if (!(var6 <= 0.0F) && !(var6 >= (float)((var4 - 1) * 16))) {
         ...
         float var9 = Shaders.sunPathRotation * MathHelper.deg2Rad;
         float var10 = var19 > MathHelper.PId2 && var19 < 3.0F * MathHelper.PId2 ? var19 + MathHelper.PI : var19;
