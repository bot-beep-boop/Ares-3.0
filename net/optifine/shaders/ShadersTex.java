...
public class ShadersTex {
   ...
   public static int[][] readImageAndMipmaps(String var0, int var1, int var2, int var3, boolean var4, int var5) {
      ...
      boolean var8 = false;
      BufferedImage var9 = readImage(updatingTextureMap.completeResourceLocation(new ResourceLocation(var0)));
      if (var9 != null) {
   ...
   public static void loadLayeredTexture(LayeredTexture var0, IResourceManager var1, List var2) {
      ...
      while(true) {
         ...
         try {
            ...
            int[] var13 = getIntArray(var5 * 3);
            var12.getRGB(0, 0, var3, var4, var13, 0, var3);
            loadNSMap(var1, var10, var3, var4, var13);

            for(int var14 = 0; var14 < var5; ++var14) {
               int var15 = var13[var14] >>> 24 & 255;
               var6[var5 * 0 + var14] = blendColor(var13[var5 * 0 + var14], var6[var5 * 0 + var14], var15);
               var6[var5 * 1 + var14] = blendColor(var13[var5 * 1 + var14], var6[var5 * 1 + var14], var15);
               var6[var5 * 2 + var14] = blendColor(var13[var5 * 2 + var14], var6[var5 * 2 + var14], var15);
            }
   ...
   private static boolean loadNSMapFile(IResourceManager var0, ResourceLocation var1, int var2, int var3, int[] var4, int var5) {
      if (var1 == null) {
         return false;
      } else {
         try {
   ...
   private static void loadNSMap1(IResourceManager var0, ResourceLocation var1, int var2, int var3, int[] var4, int var5, int var6) {
