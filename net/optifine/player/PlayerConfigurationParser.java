...
public class PlayerConfigurationParser {
   ...
   private BufferedImage downloadTextureImage(String var1) {
      String var2 = HttpUtils.getPlayerItemsUrl() + "/" + var1;
   ...
   private PlayerItemModel downloadModel(String var1) {
      ...
      try {
         ...
         PlayerItemModel var7 = PlayerItemParser.parseItemModel(var6);
         return var7;
      } catch (Exception var8) {
         Config.warn("Error loading item model " + var1 + ": " + var8.getClass().getName() + ": " + var8.getMessage());
         return null;
      }
   }
