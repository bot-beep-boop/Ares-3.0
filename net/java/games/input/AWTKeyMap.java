...
final class AWTKeyMap {
   public static final Component.Identifier.Key mapKeyCode(int var0) {
      switch(var0) {
      case 8:
   ...
   public static final Component.Identifier.Key map(KeyEvent var0) {
      int var1 = var0.getKeyCode();
      int var2 = var0.getKeyLocation();
      switch(var1) {
      case 10:
         if (var2 == 4) {
