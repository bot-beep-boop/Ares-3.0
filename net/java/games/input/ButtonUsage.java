...
final class ButtonUsage implements Usage {
   ...
   public static final ButtonUsage map(int var0) {
      Integer var1 = new Integer(var0);
      ButtonUsage var2 = (ButtonUsage)map.get(var1);
      if (var2 != null) {
         return var2;
      } else {
         ButtonUsage var3 = new ButtonUsage(var0);
         map.put(var1, var3);
         return var3;
      }
   }
