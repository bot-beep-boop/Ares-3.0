...
class LinuxNativeTypesMap {
   ...
   public static final Controller.Type guessButtonTrait(int var0) {
      switch(var0) {
      case 1:
      case 2:
      case 3:
   ...
   public static Controller.PortType getPortType(int var0) {
      switch(var0) {
      case 3:
   ...
   static {
      log = Logger.getLogger((class$net$java$games$input$LinuxNativeTypesMap == null ? (class$net$java$games$input$LinuxNativeTypesMap = class$("net.java.games.input.LinuxNativeTypesMap")) : class$net$java$games$input$LinuxNativeTypesMap).getName());
   }

   public static Component.Identifier getRelAxisID(int var0) {
      Object var1 = null;

      try {
         var1 = INSTANCE.relAxesIDs[var0];
      } catch (ArrayIndexOutOfBoundsException var3) {
         log.warning("INSTANCE.relAxesIDis only " + INSTANCE.relAxesIDs.length + " long, so " + var0 + " not contained");
      }

      if (var1 == null) {
         var1 = Component.Identifier.Axis.SLIDER_VELOCITY;
      }

      return (Component.Identifier)var1;
   }
   ...
   public static Component.Identifier getAbsAxisID(int var0) {
      Object var1 = null;

      try {
         var1 = INSTANCE.absAxesIDs[var0];
      } catch (ArrayIndexOutOfBoundsException var3) {
         log.warning("INSTANCE.absAxesIDs is only " + INSTANCE.absAxesIDs.length + " long, so " + var0 + " not contained");
      }

      if (var1 == null) {
         var1 = Component.Identifier.Axis.SLIDER;
      }

      return (Component.Identifier)var1;
   }

   public static Component.Identifier getButtonID(int var0) {
      Object var1 = null;

      try {
         var1 = INSTANCE.buttonIDs[var0];
      } catch (ArrayIndexOutOfBoundsException var3) {
         log.warning("INSTANCE.buttonIDs is only " + INSTANCE.buttonIDs.length + " long, so " + var0 + " not contained");
      }

      if (var1 == null) {
         var1 = Component.Identifier.Key.UNKNOWN;
      }
