...
public class MerchantRecipeList extends ArrayList<MerchantRecipe> {
   ...
   public MerchantRecipe canRecipeBeUsed(ItemStack var1, ItemStack var2, int var3) {
      if (var3 > 0 && var3 < this.size()) {
         ...
         return this.func_181078_a(var1, var6.getItemToBuy()) && (var2 == null && !var6.hasSecondItemToBuy() || var6.hasSecondItemToBuy() && this.func_181078_a(var2, var6.getSecondItemToBuy())) && var1.stackSize >= var6.getItemToBuy().stackSize && (!var6.hasSecondItemToBuy() || var2.stackSize >= var6.getSecondItemToBuy().stackSize) ? var6 : null;
      } else {
         for(int var4 = 0; var4 < this.size(); ++var4) {
            MerchantRecipe var5 = (MerchantRecipe)this.get(var4);
            if (this.func_181078_a(var1, var5.getItemToBuy()) && var1.stackSize >= var5.getItemToBuy().stackSize && (!var5.hasSecondItemToBuy() && var2 == null || var5.hasSecondItemToBuy() && this.func_181078_a(var2, var5.getSecondItemToBuy()) && var2.stackSize >= var5.getSecondItemToBuy().stackSize)) {
               return var5;
            }
         }
   ...
   private boolean func_181078_a(ItemStack var1, ItemStack var2) {
      return ItemStack.areItemsEqual(var1, var2) && (!var2.hasTagCompound() || var1.hasTagCompound() && NBTUtil.func_181123_a(var2.getTagCompound(), var1.getTagCompound(), false));
   }
