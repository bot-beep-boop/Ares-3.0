...
public class ScoreboardSaveData extends WorldSavedData {
   ...
   protected NBTTagList func_96496_a() {
      ...
      while(var3.hasNext()) {
         ...
         var4.setString("NameTagVisibility", var2.getNameTagVisibility().internalName);
         var4.setString("DeathMessageVisibility", var2.getDeathMessageVisibility().internalName);
