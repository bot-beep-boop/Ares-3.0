...
public class Teleporter {
   ...
   public boolean placeInExistingPortal(Entity var1, float var2) {
      ...
      if (var4 >= 0.0D) {
         ...
         double var32 = (double)((BlockPos)var9).getY() + 0.5D;
         double var33 = (double)((BlockPos)var9).getZ() + 0.5D;
         ...
         double var20 = var18.getFinger().getAxis() == EnumFacing.Axis.X ? (double)var18.getPos().getZ() : (double)var18.getPos().getX();
         var32 = (double)(var18.getPos().getY() + 1) - var1.func_181014_aG().yCoord * (double)var18.func_181119_e();
         if (var19) {
            ++var20;
         }

         if (var18.getFinger().getAxis() == EnumFacing.Axis.X) {
            var33 = var20 + (1.0D - var1.func_181014_aG().xCoord) * (double)var18.func_181118_d() * (double)var18.getFinger().rotateY().getAxisDirection().getOffset();
         } else {
            var31 = var20 + (1.0D - var1.func_181014_aG().xCoord) * (double)var18.func_181118_d() * (double)var18.getFinger().rotateY().getAxisDirection().getOffset();
         }
         ...
         var1.rotationYaw = var2 - (float)(var1.getTeleportDirection().getOpposite().getHorizontalIndex() * 90) + (float)(var18.getFinger().getHorizontalIndex() * 90);
         var1.setLocationAndAngles(var31, var32, var33, var1.rotationYaw, var1.rotationPitch);
         return true;
      } else {
         return false;
      }
