...
public class WorldServer extends World implements IThreadListener {
   ...
   private WorldServer.ServerBlockEventList[] blockEventQueue = new WorldServer.ServerBlockEventList[]{new WorldServer.ServerBlockEventList((WorldServer.ServerBlockEventList)null), new WorldServer.ServerBlockEventList((WorldServer.ServerBlockEventList)null)};
   ...
   public boolean areAllPlayersAsleep() {
      if (this.allPlayersSleeping && !this.isRemote) {
         ...
         do {
            ...
            var1 = (EntityPlayer)var2.next();
         } while(!var1.isSpectator() && var1.isPlayerFullyAsleep());
   ...
   public void saveAllChunks(boolean var1, IProgressUpdate var2) throws MinecraftException {
      if (this.chunkProvider.canSave()) {
         ...
         Iterator var4 = Lists.newArrayList(this.theChunkProviderServer.func_152380_a()).iterator();
   ...
   private void sendQueuedBlockEvents() {
      while(!this.blockEventQueue[this.blockEventCacheIndex].isEmpty()) {
         ...
         Iterator var3 = this.blockEventQueue[var1].iterator();

         while(var3.hasNext()) {
            BlockEventData var2 = (BlockEventData)var3.next();
            if (this.fireBlockEvent(var2)) {
   ...
   public void addBlockEvent(BlockPos var1, Block var2, int var3, int var4) {
      ...
      Iterator var7 = this.blockEventQueue[this.blockEventCacheIndex].iterator();
   ...
   protected BlockPos adjustPosToNearbyEntity(BlockPos var1) {
      ...
      List var4 = this.getEntitiesWithinAABB(EntityLivingBase.class, var3, new Predicate<EntityLivingBase>(this) {
   ...
   private boolean fireBlockEvent(BlockEventData var1) {
      ...
      return var2.getBlock() == var1.getBlock() ? var2.getBlock().onBlockEventReceived(this, var1.getPosition(), var2, var1.getEventID(), var1.getEventParameter()) : false;
   }
