...
public abstract class World implements IBlockAccess {
   ...
   public boolean canBlockBePlaced(Block var1, BlockPos var2, boolean var3, EnumFacing var4, Entity var5, ItemStack var6) {
      ...
      if (var8 != null && !this.checkNoEntityCollision(var8, var5)) {
         return false;
      } else if (var7.getMaterial() == Material.circuits && var1 == Blocks.anvil) {
         return true;
      } else {
         return var7.getMaterial().isReplaceable() && var1.canReplace(this, var2, var4, var6);
      }
   }
            ...
            for(int var14 = var6; var14 < var7; ++var14) {
               for(int var15 = var8; var15 < var9; ++var15) {
                  ...
                  if (var17.getMaterial() == var2) {
                     double var18 = (double)((float)(var14 + 1) - BlockLiquid.getLiquidHeightPercent((Integer)var16.getValue(BlockLiquid.LEVEL)));
   ...
   public void updateEntities() {
      ...
      for(var1 = 0; var1 < this.unloadedEntityList.size(); ++var1) {
         ...
         if (var2.addedToChunk && this.isChunkLoaded(var3, var14, true)) {
   ...
   public boolean isRainingAt(BlockPos var1) {
      if (!this.isRaining()) {
         ...
         if (var2.getEnableSnow()) {
            ...
            return this.canSnowAt(var1, false) ? false : var2.canRain();
         }
      }
   }
   ...
   public void notifyBlockOfStateChange(BlockPos var1, Block var2) {
      if (!this.isRemote) {
         ...
         try {
            ...
            var6.addCrashSectionCallable("Source block type", new Callable<String>(this, var2) {
   ...
   public List<AxisAlignedBB> getCollidingBoundingBoxes(Entity var1, AxisAlignedBB var2) {
      ...
      for(int var15 = var4; var15 < var5; ++var15) {
         for(int var16 = var8; var16 < var9; ++var16) {
            if (this.isBlockLoaded(var14.set(var15, 64, var16))) {
   ...
   public CrashReportCategory addWorldInfoToCrashReport(CrashReport var1) {
      ...
      var2.addCrashSectionCallable("All players", new Callable<String>(this) {
         final World this$0;
      ...
      var2.addCrashSectionCallable("Chunk stats", new Callable<String>(this) {
         final World this$0;
   ...
   public static boolean doesBlockHaveSolidTopSurface(IBlockAccess var0, BlockPos var1) {
      ...
      if (var3.getMaterial().isOpaque() && var3.isFullCube()) {
         ...
         return var2.getValue(BlockStairs.HALF) == BlockStairs.EnumHalf.TOP;
      } else if (var3 instanceof BlockSlab) {
         return var2.getValue(BlockSlab.HALF) == BlockSlab.EnumBlockHalf.TOP;
      } else if (var3 instanceof BlockHopper) {
         return true;
      } else if (var3 instanceof BlockSnow) {
         return (Integer)var2.getValue(BlockSnow.LAYERS) == 7;
      } else {
         return false;
      }
   }
   ...
   public boolean canBlockSeeSky(BlockPos var1) {
      if (var1.getY() >= this.getSeaLevel()) {
         ...
         if (!this.canSeeSky(var2)) {
            ...
            for(BlockPos var3 = var2.down(); var3.getY() > var1.getY(); var3 = var3.down()) {
               Block var4 = this.getBlockState(var3).getBlock();
               if (var4.getLightOpacity() > 0 && !var4.getMaterial().isLiquid()) {
                  return false;
               }
            }
   ...
   public boolean isBlockPowered(BlockPos var1) {
      if (this.getRedstonePower(var1.down(), EnumFacing.DOWN) > 0) {
         return true;
      } else if (this.getRedstonePower(var1.up(), EnumFacing.UP) > 0) {
         return true;
      } else if (this.getRedstonePower(var1.north(), EnumFacing.NORTH) > 0) {
         return true;
      } else if (this.getRedstonePower(var1.south(), EnumFacing.SOUTH) > 0) {
         return true;
      } else if (this.getRedstonePower(var1.west(), EnumFacing.WEST) > 0) {
         return true;
      } else {
         return this.getRedstonePower(var1.east(), EnumFacing.EAST) > 0;
      }
   }
   ...
   public void setWorldTime(long var1) {
      if (ConfigManager.settings.Timechanger) {
         this.worldInfo.setWorldTime((long)ConfigManager.settings.Time);
      } else {
   ...
   public BiomeGenBase getBiomeGenForCoords(BlockPos var1) {
      if (this.isBlockLoaded(var1)) {
         ...
         try {
            ...
            var5.addCrashSectionCallable("Location", new Callable<String>(this, var1) {
   ...
   public List<AxisAlignedBB> getCollisionBoxes(AxisAlignedBB var1) {
      ...
      for(int var10 = var3; var10 < var4; ++var10) {
         for(int var11 = var7; var11 < var8; ++var11) {
            if (this.isBlockLoaded(var9.set(var10, 64, var11))) {
   ...
   public long getWorldTime() {
      return ConfigManager.settings.Timechanger ? (long)ConfigManager.settings.Time : this.worldInfo.getWorldTime();
   }
