...
public class ChunkProviderGenerate implements IChunkProvider {
   ...
   public void populate(IChunkProvider var1, int var2, int var3) {
      ...
      if (!var12 && this.rand.nextInt(this.settings.lavaLakeChance / 10) == 0 && this.settings.useLavaLakes) {
         ...
         var16 = this.rand.nextInt(16) + 8;
         if (var15 < this.worldObj.getSeaLevel() || this.rand.nextInt(this.settings.lavaLakeChance / 8) == 0) {
   ...
   private void func_147423_a(int var1, int var2, int var3) {
      this.depthNoiseArray = this.noiseGen6.generateNoiseOctaves(this.depthNoiseArray, var1, var3, 5, 5, (double)this.settings.depthNoiseScaleX, (double)this.settings.depthNoiseScaleZ, (double)this.settings.depthNoiseScaleExponent);
      float var4 = this.settings.coordinateScale;
      float var5 = this.settings.heightScale;
      this.mainNoiseArray = this.field_147429_l.generateNoiseOctaves(this.mainNoiseArray, var1, var2, var3, 5, 33, 5, (double)(var4 / this.settings.mainNoiseScaleX), (double)(var5 / this.settings.mainNoiseScaleY), (double)(var4 / this.settings.mainNoiseScaleZ));
      this.lowerLimitNoiseArray = this.field_147431_j.generateNoiseOctaves(this.lowerLimitNoiseArray, var1, var2, var3, 5, 33, 5, (double)var4, (double)var5, (double)var4);
      this.upperLimitNoiseArray = this.field_147432_k.generateNoiseOctaves(this.upperLimitNoiseArray, var1, var2, var3, 5, 33, 5, (double)var4, (double)var5, (double)var4);
      boolean var37 = false;
      boolean var36 = false;
      int var6 = 0;
      int var7 = 0;
      ...
      for(int var8 = 0; var8 < 5; ++var8) {
         for(int var9 = 0; var9 < 5; ++var9) {
            ...
            double var38 = this.depthNoiseArray[var7] / 8000.0D;
            if (var38 < 0.0D) {
               var38 = -var38 * 0.3D;
            }
            ...
            for(int var23 = 0; var23 < 33; ++var23) {
               ...
               double var26 = this.lowerLimitNoiseArray[var6] / (double)this.settings.lowerLimitScale;
               double var28 = this.upperLimitNoiseArray[var6] / (double)this.settings.upperLimitScale;
               double var30 = (this.mainNoiseArray[var6] / 10.0D + 1.0D) / 2.0D;
