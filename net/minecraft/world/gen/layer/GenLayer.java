...
public abstract class GenLayer {
   ...
   protected static boolean biomesEqualOrMesaPlateau(int var0, int var1) {
      if (var0 == var1) {
         ...
         try {
            ...
            var6.addCrashSectionCallable("Biome A", new Callable<String>(var2) {
            ...
            var6.addCrashSectionCallable("Biome B", new Callable<String>(var3) {
   ...
   public static GenLayer[] initializeAllBiomeGenerators(long var0, WorldType var2, String var3) {
      ...
      Object var34 = new GenLayerRareBiome(1001L, var26);

      for(int var30 = 0; var30 < var18; ++var30) {
         var34 = new GenLayerZoom((long)(1000 + var30), (GenLayer)var34);
         if (var30 == 0) {
            var34 = new GenLayerAddIsland(3L, (GenLayer)var34);
         }

         if (var30 == 1 || var18 == 1) {
            var34 = new GenLayerShore(1000L, (GenLayer)var34);
         }
      }

      GenLayerSmooth var35 = new GenLayerSmooth(1000L, (GenLayer)var34);
      GenLayerRiverMix var31 = new GenLayerRiverMix(100L, var35, var29);
