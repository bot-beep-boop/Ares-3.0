...
public class GenLayerShore extends GenLayer {
   ...
   private boolean func_151631_c(int var1) {
      if (BiomeGenBase.getBiome(var1) != null && BiomeGenBase.getBiome(var1).getBiomeClass() == BiomeGenJungle.class) {
         return true;
      } else {
         return var1 == BiomeGenBase.jungleEdge.biomeID || var1 == BiomeGenBase.jungle.biomeID || var1 == BiomeGenBase.jungleHills.biomeID || var1 == BiomeGenBase.forest.biomeID || var1 == BiomeGenBase.taiga.biomeID || isBiomeOceanic(var1);
      }
   }
