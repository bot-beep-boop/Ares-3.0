...
public class StructureOceanMonumentPieces {
   ...
   public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
         ...
         while(var12.hasNext()) {
            StructureOceanMonumentPieces.Piece var11 = (StructureOceanMonumentPieces.Piece)var12.next();
            if (var11.getBoundingBox().intersectsWith(var3)) {
               var11.addComponentParts(var1, var2, var3);
            }
         }
      ...
      private void func_175840_a(boolean var1, int var2, World var3, Random var4, StructureBoundingBox var5) {
         ...
         if (this.func_175818_a(var5, var2, 0, var2 + 23, 20)) {
            this.fillWithBlocks(var3, var5, var2, 0, 0, var2 + 24, 0, 20, field_175828_a, field_175828_a, false);
            this.func_181655_a(var3, var5, var2, 1, 0, var2 + 24, 10, 20, false);
               ...
               do {
                  do {
                     if (!var8.hasNext()) {
                        ...
                        while(var11.hasNext()) {
                           StructureOceanMonumentPieces.Piece var17 = (StructureOceanMonumentPieces.Piece)var11.next();
                           var17.getBoundingBox().offset(var15, var14, var16);
                        }
      ...
      public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
         ...
         for(var6 = 1; var6 <= 6; ++var6) {
            ...
            for(var7 = 0; var7 <= 15; var7 += 15) {
               this.fillWithBlocks(var1, var3, var7, var6, 0, var7, var6, 1, var5, var5, false);
               this.fillWithBlocks(var1, var3, var7, var6, 6, var7, var6, 9, var5, var5, false);
               this.fillWithBlocks(var1, var3, var7, var6, 14, var7, var6, 15, var5, var5, false);
            }

            this.fillWithBlocks(var1, var3, 1, var6, 0, 1, var6, 0, var5, var5, false);
            this.fillWithBlocks(var1, var3, 6, var6, 0, 9, var6, 0, var5, var5, false);
            this.fillWithBlocks(var1, var3, 14, var6, 0, 14, var6, 0, var5, var5, false);
            this.fillWithBlocks(var1, var3, 1, var6, 15, 14, var6, 15, var5, var5, false);
         }
         ...
         for(var6 = 3; var6 <= 6; var6 += 3) {
            for(var7 = 6; var7 <= 9; var7 += 3) {
               this.setBlockState(var1, field_175825_e, var7, var6, 6, var3);
               this.setBlockState(var1, field_175825_e, var7, var6, 9, var3);
            }
         }
   ...
   public abstract static class Piece extends StructureComponent {
      ...
      protected void func_175821_a(World var1, StructureBoundingBox var2, int var3, int var4, boolean var5) {
         if (var5) {
            this.fillWithBlocks(var1, var2, var3, 0, var4, var3 + 2, 0, var4 + 8 - 1, field_175828_a, field_175828_a, false);
            this.fillWithBlocks(var1, var2, var3 + 5, 0, var4, var3 + 8 - 1, 0, var4 + 8 - 1, field_175828_a, field_175828_a, false);
            this.fillWithBlocks(var1, var2, var3 + 3, 0, var4, var3 + 4, 0, var4 + 2, field_175828_a, field_175828_a, false);
            ...
            this.fillWithBlocks(var1, var2, var3, 0, var4, var3 + 8 - 1, 0, var4 + 8 - 1, field_175828_a, field_175828_a, false);
         }
