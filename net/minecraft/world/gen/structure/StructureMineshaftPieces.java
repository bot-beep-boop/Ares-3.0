...
public class StructureMineshaftPieces {
   ...
   public static class Room extends StructureComponent {
      ...
      public void buildComponent(StructureComponent var1, List<StructureComponent> var2, Random var3) {
         ...
         for(boolean var7 = false; var6 < this.boundingBox.getXSize(); var6 += 4) {
            var6 += var3.nextInt(this.boundingBox.getXSize());
            if (var6 + 3 > this.boundingBox.getXSize()) {
               break;
            }

            StructureComponent var8 = StructureMineshaftPieces.access$0(var1, var2, var3, this.boundingBox.minX + var6, this.boundingBox.minY + var3.nextInt(var5) + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, var4);
            if (var8 != null) {
         ...
         StructureComponent var10;
         StructureBoundingBox var11;
         for(var6 = 0; var6 < this.boundingBox.getXSize(); var6 += 4) {
            ...
            var10 = StructureMineshaftPieces.access$0(var1, var2, var3, this.boundingBox.minX + var6, this.boundingBox.minY + var3.nextInt(var5) + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, var4);
            if (var10 != null) {
               var11 = var10.getBoundingBox();
               this.roomsLinkedToTheRoom.add(new StructureBoundingBox(var11.minX, var11.minY, this.boundingBox.maxZ - 1, var11.maxX, var11.maxY, this.boundingBox.maxZ));
            }
         }
         ...
         for(var6 = 0; var6 < this.boundingBox.getZSize(); var6 += 4) {
            ...
            var10 = StructureMineshaftPieces.access$0(var1, var2, var3, this.boundingBox.minX - 1, this.boundingBox.minY + var3.nextInt(var5) + 1, this.boundingBox.minZ + var6, EnumFacing.WEST, var4);
            if (var10 != null) {
               var11 = var10.getBoundingBox();
               this.roomsLinkedToTheRoom.add(new StructureBoundingBox(this.boundingBox.minX, var11.minY, var11.minZ, this.boundingBox.minX + 1, var11.maxY, var11.maxZ));
            }
         }
         ...
         for(var6 = 0; var6 < this.boundingBox.getZSize(); var6 += 4) {
            ...
            var10 = StructureMineshaftPieces.access$0(var1, var2, var3, this.boundingBox.maxX + 1, this.boundingBox.minY + var3.nextInt(var5) + 1, this.boundingBox.minZ + var6, EnumFacing.EAST, var4);
            if (var10 != null) {
               var11 = var10.getBoundingBox();
               this.roomsLinkedToTheRoom.add(new StructureBoundingBox(this.boundingBox.maxX - 1, var11.minY, var11.minZ, this.boundingBox.maxX, var11.maxY, var11.maxZ));
            }
         }
   ...
   public static class Corridor extends StructureComponent {
      ...
      protected boolean generateChestContents(World var1, StructureBoundingBox var2, Random var3, int var4, int var5, int var6, List<WeightedRandomChestContent> var7, int var8) {
         ...
         if (this.isLiquidInStructureBoundingBox(var1, var3)) {
            ...
            for(var9 = 0; var9 <= 2; ++var9) {
               for(var10 = 0; var10 <= var8; ++var10) {
                  byte var17 = -1;
                  IBlockState var18 = this.getBlockStateFromPos(var1, var9, var17, var10, var3);
                  if (var18.getBlock().getMaterial() == Material.air) {
                     byte var19 = -1;
                     this.setBlockState(var1, Blocks.planks.getDefaultState(), var9, var19, var10, var3);
                  }
               }
            }
            ...
            if (this.hasRails) {
               for(var9 = 0; var9 <= var8; ++var9) {
                  IBlockState var16 = this.getBlockStateFromPos(var1, 1, -1, var9, var3);
