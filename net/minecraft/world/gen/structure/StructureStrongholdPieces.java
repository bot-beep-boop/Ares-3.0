...
public class StructureStrongholdPieces {
   ...
   private static StructureStrongholdPieces.Stronghold func_175955_b(StructureStrongholdPieces.Stairs2 var0, List<StructureComponent> var1, Random var2, int var3, int var4, int var5, EnumFacing var6, int var7) {
      if (!canAddStructurePieces()) {
         ...
         while(var13 < 5) {
            ...
            Iterator var11 = structurePieceList.iterator();

            while(var11.hasNext()) {
               StructureStrongholdPieces.PieceWeight var10 = (StructureStrongholdPieces.PieceWeight)var11.next();
               var9 -= var10.pieceWeight;
               if (var9 < 0) {
                  if (!var10.canSpawnMoreStructuresOfType(var7) || var10 == var0.strongholdPieceWeight) {
                     break;
                  }

                  StructureStrongholdPieces.Stronghold var12 = func_175954_a(var10.pieceClass, var1, var2, var3, var4, var5, var6, var7);
                  if (var12 != null) {
                     ++var10.instancesSpawned;
                     var0.strongholdPieceWeight = var10;
                     if (!var10.canSpawnMoreStructures()) {
                        structurePieceList.remove(var10);
                     }
   ...
   abstract static class Stronghold extends StructureComponent {
      ...
      protected StructureComponent getNextComponentNormal(StructureStrongholdPieces.Stairs2 var1, List<StructureComponent> var2, Random var3, int var4, int var5) {
         if (this.coordBaseMode != null) {
            switch($SWITCH_TABLE$net$minecraft$util$EnumFacing()[this.coordBaseMode.ordinal()]) {
            case 3:
