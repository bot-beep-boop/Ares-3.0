...
public class Chunk {
   ...
   public IBlockState getBlockState(BlockPos var1) {
      if (this.worldObj.getWorldType() == WorldType.DEBUG_WORLD) {
         ...
         try {
            ...
            var4.addCrashSectionCallable("Location", new Callable<String>(this, var1) {
               final Chunk this$0;
   ...
   private boolean func_150811_f(int var1, int var2) {
      ...
      int var7;
      for(var7 = var3 + 16 - 1; var7 > this.worldObj.getSeaLevel() || var7 > 0 && !var5; --var7) {
         var6.set(var6.getX(), var7, var6.getZ());
         int var8 = this.getBlockLightOpacity(var6);
         if (var8 == 255 && var6.getY() < this.worldObj.getSeaLevel()) {
            var5 = true;
         }
   ...
   public Block getBlock(BlockPos var1) {
      try {
         ...
         var3.addCrashSectionCallable("Location", new Callable<String>(this, var1) {
            final Chunk this$0;
            private final BlockPos val$pos;
         ...
         for(int var2 = 0; var2 < 16; ++var2) {
            for(int var3 = 0; var3 < 16; ++var3) {
               if (this.updateSkylightColumns[var2 + var3 * 16]) {
                  ...
                  EnumFacing var8;
                  Iterator var9;
                  for(var9 = EnumFacing.Plane.HORIZONTAL.iterator(); var9.hasNext(); var7 = Math.min(var7, this.worldObj.getChunksLowestHorizon(var5 + var8.getFrontOffsetX(), var6 + var8.getFrontOffsetZ()))) {
                     var8 = (EnumFacing)var9.next();
                  }
                  ...
                  while(var9.hasNext()) {
                     var8 = (EnumFacing)var9.next();
                     this.checkSkylightNeighborHeight(var5 + var8.getFrontOffsetX(), var6 + var8.getFrontOffsetZ(), var4);
                  }
   ...
   public void populateChunk(IChunkProvider var1, IChunkProvider var2, int var3, int var4) {
      ...
      if (var5 && var6 && var12) {
         ...
         if (!var13.isTerrainPopulated) {
            ...
            var1.populateChunk(var2, var13, var3, var4 - 1);
         }
      }
      ...
      if (var9 && var5 && var8) {
         ...
         if (!var13.isTerrainPopulated) {
            ...
            var1.populateChunk(var2, var13, var3 - 1, var4 - 1);
         }
      }
   ...
   public Block getBlock(int var1, int var2, int var3) {
      try {
         ...
         var5.addCrashSectionCallable("Location", new Callable<String>(this, var1, var2, var3) {
   ...
   public void func_150809_p() {
      ...
      BlockPos var1 = new BlockPos(this.xPosition << 4, 0, this.zPosition << 4);
      if (!this.worldObj.provider.getHasNoSky()) {
         if (this.worldObj.isAreaLoaded(var1.add(-1, 0, -1), var1.add(16, this.worldObj.getSeaLevel(), 16))) {
            label61:
            for(int var2 = 0; var2 < 16; ++var2) {
               for(int var3 = 0; var3 < 16; ++var3) {
            ...
            if (this.isLightPopulated) {
               ...
               while(var6.hasNext()) {
                  EnumFacing var5 = (EnumFacing)var6.next();
                  int var4 = var5.getAxisDirection() == EnumFacing.AxisDirection.POSITIVE ? 16 : 1;
                  this.worldObj.getChunkFromBlockCoords(var1.offset(var5, var4)).func_180700_a(var5.getOpposite());
               }
      ...
      if (var5 != var4) {
         ...
         if (!this.worldObj.provider.getHasNoSky()) {
            ...
            while(var12.hasNext()) {
               ...
               this.updateSkylightNeighborHeight(var6 + var11.getFrontOffsetX(), var7 + var11.getFrontOffsetZ(), var13, var14);
            }
   ...
   public int getLightFor(EnumSkyBlock var1, BlockPos var2) {
      ...
      if (var6 == null) {
         ...
         return this.worldObj.provider.getHasNoSky() ? 0 : var6.getExtSkylightValue(var3, var4 & 15, var5);
      } else {
         return var1 == EnumSkyBlock.BLOCK ? var6.getExtBlocklightValue(var3, var4 & 15, var5) : var1.defaultLightValue;
      }
   }
   ...
   public void addEntity(Entity var1) {
      ...
      if (var2 != this.xPosition || var3 != this.zPosition) {
         logger.warn("Wrong location! (" + var2 + ", " + var3 + ") should be (" + this.xPosition + ", " + this.zPosition + "), " + var1, new Object[]{var1});
         var1.setDead();
      }
