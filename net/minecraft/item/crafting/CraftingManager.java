...
public class CraftingManager {
   ...
   public void addShapelessRecipe(ItemStack var1, Object... var2) {
      ...
      for(int var5 = 0; var5 < var6; ++var5) {
         ...
         if (var4 instanceof ItemStack) {
            var3.add(((ItemStack)var4).copy());
         } else if (var4 instanceof Item) {
            var3.add(new ItemStack((Item)var4));
         } else {
            if (!(var4 instanceof Block)) {
               throw new IllegalArgumentException("Invalid shapeless recipe: unknown type " + var4.getClass().getName() + "!");
            }

            var3.add(new ItemStack((Block)var4));
         }
      }
   ...
   public ItemStack findMatchingRecipe(InventoryCrafting var1, World var2) {
      ...
      while(var4.hasNext()) {
         IRecipe var3 = (IRecipe)var4.next();
   ...
   public ItemStack[] func_180303_b(InventoryCrafting var1, World var2) {
      ...
      while(var4.hasNext()) {
         IRecipe var3 = (IRecipe)var4.next();
         if (var3.matches(var1, var2)) {
            return var3.getRemainingItems(var1);
         }
      }
