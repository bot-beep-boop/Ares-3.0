...
public class ItemMonsterPlacer extends Item {
   public int getColorFromItemStack(ItemStack var1, int var2) {
      ...
      if (var3 != null) {
         return var2 == 0 ? var3.primaryColor : var3.secondaryColor;
      } else {
         return 16777215;
      }
   }
   ...
   public void getSubItems(Item var1, CreativeTabs var2, List<ItemStack> var3) {
      Iterator var5 = EntityList.entityEggs.values().iterator();

      while(var5.hasNext()) {
         EntityList.EntityEggInfo var4 = (EntityList.EntityEggInfo)var5.next();
         var3.add(new ItemStack(var1, 1, var4.spawnedID));
      }
      ...
      if (var2.isRemote) {
         ...
         if (var4 == null) {
            ...
            if (var4.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
               ...
               if (!var3.canPlayerEdit(var5, var4.sideHit, var1)) {
                  return var1;
               }
