      ...
      if (var5 == null) {
         ...
         if (var5.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (var4) {
               ...
               if (this.tryPlaceContainedLiquid(var2, var9) && !var3.capabilities.isCreativeMode) {
                  var3.triggerAchievement(StatList.objectUseStats[Item.getIdFromItem(this)]);
                  return new ItemStack(Items.bucket);
               }
            }
         ...
         if (!var1.isAirBlock(var2) && !var4) {
            ...
            if (var1.provider.doesWaterVaporize() && this.isFull == Blocks.flowing_water) {
               ...
               for(int var8 = 0; var8 < 8; ++var8) {
                  var1.spawnParticle(EnumParticleTypes.SMOKE_LARGE, (double)var5 + Math.random(), (double)var6 + Math.random(), (double)var7 + Math.random(), 0.0D, 0.0D, 0.0D);
               }
            } else {
               if (!var1.isRemote && var4 && !var3.isLiquid()) {
