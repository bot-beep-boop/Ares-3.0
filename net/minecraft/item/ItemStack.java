...
public final class ItemStack {
   ...
   public static boolean areItemsEqual(ItemStack var0, ItemStack var1) {
      if (var0 == null && var1 == null) {
         ...
         return var0 != null && var1 != null ? var0.isItemEqual(var1) : false;
      }
   }
   ...
   private boolean isItemStackEqual(ItemStack var1) {
      if (this.stackSize != var1.stackSize) {
         ...
         return false;
      } else if (this.stackTagCompound == null && var1.stackTagCompound != null) {
         return false;
      } else {
         return this.stackTagCompound == null || this.stackTagCompound.equals(var1.stackTagCompound);
      }
   }
   ...
   public static boolean areItemStackTagsEqual(ItemStack var0, ItemStack var1) {
      if (var0 == null && var1 == null) {
         ...
         if (var0.stackTagCompound == null && var1.stackTagCompound != null) {
            return false;
         } else {
            return var0.stackTagCompound == null || var0.stackTagCompound.equals(var1.stackTagCompound);
         }
      } else {
         return false;
      }
      ...
      if (!var17.isEmpty() && (var14 & 2) == 0) {
         ...
         while(var21.hasNext()) {
            ...
            if (var22.getID() == Item.itemModifierUUID) {
               var10 += (double)EnchantmentHelper.getModifierForCreature(this, EnumCreatureAttribute.UNDEFINED);
            }
