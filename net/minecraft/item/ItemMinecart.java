...
public class ItemMinecart extends Item {
   private static final IBehaviorDispenseItem dispenserMinecartBehavior = new BehaviorDefaultDispenseItem() {
      ...
      public ItemStack dispenseStack(IBlockSource var1, ItemStack var2) {
         ...
         EntityMinecart var18 = EntityMinecart.getMinecart(var4, var5, var7 + var14, var9, ItemMinecart.access$0((ItemMinecart)var2.getItem()));
   ...
   public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, BlockPos var4, EnumFacing var5, float var6, float var7, float var8) {
      ...
      if (BlockRailBase.isRailBlock(var9)) {
         if (!var3.isRemote) {
            ...
            EntityMinecart var13 = EntityMinecart.getMinecart(var3, (double)var4.getX() + 0.5D, (double)var4.getY() + 0.0625D + var11, (double)var4.getZ() + 0.5D, this.minecartType);
