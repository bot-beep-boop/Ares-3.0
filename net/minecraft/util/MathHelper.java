...
public class MathHelper {
   ...
   public static float cos(float var0) {
      return fastMath ? SIN_TABLE_FAST[(int)(var0 * radToIndex + 1024.0F) & 4095] : SIN_TABLE[(int)(var0 * 10430.378F + 16384.0F) & '\uffff'];
   }
   ...
   public static float sin(float var0) {
      return fastMath ? SIN_TABLE_FAST[(int)(var0 * radToIndex) & 4095] : SIN_TABLE[(int)(var0 * 10430.378F) & '\uffff'];
   }
   ...
   static {
      ...
      for(var0 = 0; var0 < SIN_TABLE_FAST.length; ++var0) {
         SIN_TABLE_FAST[var0] = MathUtils.roundToFloat(Math.sin((double)var0 * 3.141592653589793D * 2.0D / 4096.0D));
      }
