      ...
      public IChatComponent deserialize(JsonElement var1, Type var2, JsonDeserializationContext var3) throws JsonParseException {
         if (var1.isJsonPrimitive()) {
            ...
            if (var4.has("text")) {
               ...
               var5 = new ChatComponentScore(JsonUtils.getString(var12, "name"), JsonUtils.getString(var12, "objective"));
               if (var12.has("value")) {
                  ((ChatComponentScore)var5).setValue(JsonUtils.getString(var12, "value"));
               }
            } else {
