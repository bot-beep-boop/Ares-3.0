...
public class BlockRedstoneComparator extends BlockRedstoneDiode implements ITileEntityProvider {
   ...
   private EntityItemFrame findItemFrame(World var1, EnumFacing var2, BlockPos var3) {
      List var4 = var1.getEntitiesWithinAABB(EntityItemFrame.class, new AxisAlignedBB((double)var3.getX(), (double)var3.getY(), (double)var3.getZ(), (double)(var3.getX() + 1), (double)(var3.getY() + 1), (double)(var3.getZ() + 1)), new Predicate<Entity>(this, var2) {
