...
public class Block {
   ...
   public boolean shouldSideBeRendered(IBlockAccess var1, BlockPos var2, EnumFacing var3) {
      if (var3 == EnumFacing.DOWN && this.minY > 0.0D) {
         return true;
      } else if (var3 == EnumFacing.UP && this.maxY < 1.0D) {
         return true;
      } else if (var3 == EnumFacing.NORTH && this.minZ > 0.0D) {
         return true;
      } else if (var3 == EnumFacing.SOUTH && this.maxZ < 1.0D) {
         return true;
      } else if (var3 == EnumFacing.WEST && this.minX > 0.0D) {
         return true;
      } else if (var3 == EnumFacing.EAST && this.maxX < 1.0D) {
         return true;
      } else {
         return !var1.getBlockState(var2).getBlock().isOpaqueCube();
      }
   }
   ...
   public static boolean isEqualTo(Block var0, Block var1) {
      if (var0 != null && var1 != null) {
         return var0 == var1 ? true : var0.isAssociatedBlock(var1);
      } else {
         return false;
      }
   }
   ...
   public float getPlayerRelativeBlockHardness(EntityPlayer var1, World var2, BlockPos var3) {
      ...
      if (var4 < 0.0F) {
         ...
         return !var1.canHarvestBlock(this) ? var1.getToolDigEfficiency(this) / var4 / 100.0F : var1.getToolDigEfficiency(this) / var4 / 30.0F;
      }
   }
   ...
   public static void registerBlocks() {
      ...
      registerBlock(85, (String)"fence", (new BlockFence(Material.wood, BlockPlanks.EnumType.OAK.getMapColor())).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setUnlocalizedName("fence"));
      ...
      registerBlock(188, (String)"spruce_fence", (new BlockFence(Material.wood, BlockPlanks.EnumType.SPRUCE.getMapColor())).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setUnlocalizedName("spruceFence"));
      registerBlock(189, (String)"birch_fence", (new BlockFence(Material.wood, BlockPlanks.EnumType.BIRCH.getMapColor())).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setUnlocalizedName("birchFence"));
      registerBlock(190, (String)"jungle_fence", (new BlockFence(Material.wood, BlockPlanks.EnumType.JUNGLE.getMapColor())).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setUnlocalizedName("jungleFence"));
      registerBlock(191, (String)"dark_oak_fence", (new BlockFence(Material.wood, BlockPlanks.EnumType.DARK_OAK.getMapColor())).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setUnlocalizedName("darkOakFence"));
      registerBlock(192, (String)"acacia_fence", (new BlockFence(Material.wood, BlockPlanks.EnumType.ACACIA.getMapColor())).setHardness(2.0F).setResistance(5.0F).setStepSound(soundTypeWood).setUnlocalizedName("acaciaFence"));
      ...
      while(true) {
         ...
         while(var14.hasNext()) {
            var13 = (Block)var14.next();
            Iterator var22 = var13.getBlockState().getValidStates().iterator();

            while(var22.hasNext()) {
               IBlockState var21 = (IBlockState)var22.next();
               int var23 = blockRegistry.getIDForObject(var13) << 4 | var13.getMetaFromState(var21);
               BLOCK_STATE_IDS.put(var21, var23);
            }
         }
