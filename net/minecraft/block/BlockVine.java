            ...
            if (!var7) {
               ...
               while(true) {
                  ...
                  do {
                     ...
                     var23 = (EnumFacing)var25.next();
                  } while(!var4.nextBoolean() && this.canPlaceOn(var1.getBlockState(var19.offset(var23)).getBlock()));

                  var21 = var21.withProperty(getPropertyFor(var23), false);
               }
            }
         } else {
            BlockPos var20;
            if (var18.getAxis().isHorizontal() && !(Boolean)var3.getValue(getPropertyFor(var18))) {
               if (!var7) {
                  ...
                  if (var22.blockMaterial == Material.air) {
                     ...
                     if (var27 && this.canPlaceOn(var1.getBlockState(var29).getBlock())) {
                        var1.setBlockState(var20, this.getDefaultState().withProperty(getPropertyFor(var24), true), 2);
                     } else if (var28 && this.canPlaceOn(var1.getBlockState(var17).getBlock())) {
                        var1.setBlockState(var20, this.getDefaultState().withProperty(getPropertyFor(var26), true), 2);
                     } else if (var27 && var1.isAirBlock(var29) && this.canPlaceOn(var1.getBlockState(var2.offset(var24)).getBlock())) {
                        var1.setBlockState(var29, this.getDefaultState().withProperty(getPropertyFor(var18.getOpposite()), true), 2);
                     } else if (var28 && var1.isAirBlock(var17) && this.canPlaceOn(var1.getBlockState(var2.offset(var26)).getBlock())) {
               ...
               if (var12.blockMaterial == Material.air) {
                  ...
                  while(var15.hasNext()) {
                     var14 = (EnumFacing)var15.next();
                     if (var4.nextBoolean()) {
                        var13 = var13.withProperty(getPropertyFor(var14), false);
                     }
                  }
                  ...
                  while(var15.hasNext()) {
                     var14 = (EnumFacing)var15.next();
                     PropertyBool var16 = getPropertyFor(var14);
         ...
         do {
            ...
            do {
               do {
                  ...
                  var7 = getPropertyFor(var5);
               } while(!(Boolean)var3.getValue(var7));
            } while(this.canPlaceOn(var1.getBlockState(var2.offset(var5)).getBlock()));

            var8 = var1.getBlockState(var2.up());
