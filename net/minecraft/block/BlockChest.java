...
public class BlockChest extends BlockContainer {
   ...
   private boolean isOcelotSittingOnChest(World var1, BlockPos var2) {
      Iterator var4 = var1.getEntitiesWithinAABB(EntityOcelot.class, new AxisAlignedBB((double)var2.getX(), (double)(var2.getY() + 1), (double)var2.getZ(), (double)(var2.getX() + 1), (double)(var2.getY() + 2), (double)(var2.getZ() + 1))).iterator();

      while(var4.hasNext()) {
         Entity var3 = (Entity)var4.next();
         EntityOcelot var5 = (EntityOcelot)var3;
         if (var5.isSitting()) {
            return true;
         }
      }
   ...
   private boolean isDoubleChest(World var1, BlockPos var2) {
      if (var1.getBlockState(var2).getBlock() != this) {
         ...
         while(var4.hasNext()) {
            ...
            if (var1.getBlockState(var2.offset(var3)).getBlock() == this) {
               return true;
            }
         }
   ...
   public IBlockState correctFacing(World var1, BlockPos var2, IBlockState var3) {
      ...
      while(var6.hasNext()) {
         var5 = (EnumFacing)var6.next();
         IBlockState var7 = var1.getBlockState(var2.offset(var5));
         if (var7.getBlock() == this) {
            return var3;
         }
      ...
      if (var4 != null) {
         ...
         var5 = (EnumFacing)var3.getValue(FACING);
         if (var1.getBlockState(var2.offset(var5)).getBlock().isFullBlock()) {
         ...
         return var3.withProperty(FACING, var5);
      }
   }
