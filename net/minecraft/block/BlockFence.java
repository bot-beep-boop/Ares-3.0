...
public class BlockFence extends Block {
   ...
   public boolean canConnectTo(IBlockAccess var1, BlockPos var2) {
      ...
      if (var3 == Blocks.barrier) {
         return false;
      } else if ((!(var3 instanceof BlockFence) || var3.blockMaterial != this.blockMaterial) && !(var3 instanceof BlockFenceGate)) {
         if (var3.blockMaterial.isOpaque() && var3.isFullCube()) {
            return var3.blockMaterial != Material.gourd;
         } else {
            return false;
         }
      } else {
