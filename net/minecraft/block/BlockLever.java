...
public class BlockLever extends Block {
   ...
   public boolean canPlaceBlockAt(World var1, BlockPos var2) {
      ...
      for(int var4 = 0; var4 < var5; ++var4) {
         ...
         if (func_181090_a(var1, var2, var3)) {
            return true;
         }
      }
   ...
   public int getStrongPower(IBlockAccess var1, BlockPos var2, IBlockState var3, EnumFacing var4) {
      if (!(Boolean)var3.getValue(POWERED)) {
         ...
         return ((BlockLever.EnumOrientation)var3.getValue(FACING)).getFacing() == var4 ? 15 : 0;
      }
   }
   ...
   public IBlockState onBlockPlaced(World var1, BlockPos var2, EnumFacing var3, float var4, float var5, float var6, int var7, EntityLivingBase var8) {
      ...
      if (func_181090_a(var1, var2, var3.getOpposite())) {
         ...
         do {
            if (!var11.hasNext()) {
               return World.doesBlockHaveSolidTopSurface(var1, var2.down()) ? var9.withProperty(FACING, BlockLever.EnumOrientation.forFacings(EnumFacing.UP, var8.getHorizontalFacing())) : var9;
            }

            var10 = (EnumFacing)var11.next();
         } while(var10 == var3 || !func_181090_a(var1, var2, var10.getOpposite()));

         return var9.withProperty(FACING, BlockLever.EnumOrientation.forFacings(var10, var8.getHorizontalFacing()));
      }
   }
