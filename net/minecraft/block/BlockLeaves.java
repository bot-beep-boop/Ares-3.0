                     ...
                     for(var15 = -var5; var15 <= var5; ++var15) {
                        for(var16 = -var5; var16 <= var5; ++var16) {
                           for(int var19 = -var5; var19 <= var5; ++var19) {
                              if (this.surroundings[(var15 + var12) * var11 + (var16 + var12) * var10 + var19 + var12] == var14 - 1) {
                                 if (this.surroundings[(var15 + var12 - 1) * var11 + (var16 + var12) * var10 + var19 + var12] == -2) {
                                    this.surroundings[(var15 + var12 - 1) * var11 + (var16 + var12) * var10 + var19 + var12] = var14;
                                 }
                                 ...
                                 if (this.surroundings[(var15 + var12) * var11 + (var16 + var12 - 1) * var10 + var19 + var12] == -2) {
                                    this.surroundings[(var15 + var12) * var11 + (var16 + var12 - 1) * var10 + var19 + var12] = var14;
                                 }
                                 ...
                                 if (this.surroundings[(var15 + var12) * var11 + (var16 + var12) * var10 + (var19 + var12 - 1)] == -2) {
                                    this.surroundings[(var15 + var12) * var11 + (var16 + var12) * var10 + (var19 + var12 - 1)] = var14;
                                 }
