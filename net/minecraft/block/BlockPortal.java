   ...
   public BlockPattern.PatternHelper func_181089_f(World var1, BlockPos var2) {
      ...
      if (!var4.func_150860_b()) {
         ...
         for(int var10 = 0; var10 < var11; ++var10) {
            var9 = var12[var10];
            BlockPattern.PatternHelper var13 = new BlockPattern.PatternHelper(var7.getAxisDirection() == var9 ? var8 : var8.offset(BlockPortal.Size.access$3(var4), var4.func_181101_b() - 1), EnumFacing.getFacingFromAxis(var9, var3), EnumFacing.UP, var5, var4.func_181101_b(), var4.func_181100_a(), 1);
         ...
         return new BlockPattern.PatternHelper(var7.getAxisDirection() == var9 ? var8 : var8.offset(BlockPortal.Size.access$3(var4), var4.func_181101_b() - 1), EnumFacing.getFacingFromAxis(var9, var3), EnumFacing.UP, var5, var4.func_181101_b(), var4.func_181100_a(), 1);
      }
   }
