...
public abstract class BlockRedstoneDiode extends BlockDirectional {
   ...
   public int getWeakPower(IBlockAccess var1, BlockPos var2, IBlockState var3, EnumFacing var4) {
      if (!this.isPowered(var3)) {
         return 0;
      } else {
         return var3.getValue(FACING) == var4 ? this.getActiveSignal(var1, var2, var3) : 0;
      }
   }
   ...
   protected int getPowerOnSide(IBlockAccess var1, BlockPos var2, EnumFacing var3) {
      ...
      if (this.canPowerSide(var5)) {
         return var5 == Blocks.redstone_wire ? (Integer)var4.getValue(BlockRedstoneWire.POWER) : var1.getStrongPower(var2, var3);
      } else {
         return 0;
      }
   }
   ...
   public boolean isFacingTowardsRepeater(World var1, BlockPos var2, IBlockState var3) {
      ...
      BlockPos var5 = var2.offset(var4);
      if (isRedstoneRepeaterBlockID(var1.getBlockState(var5).getBlock())) {
         return var1.getBlockState(var5).getValue(FACING) != var4;
      } else {
         return false;
      }
   }
