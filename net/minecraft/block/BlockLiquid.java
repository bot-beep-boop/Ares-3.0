...
public abstract class BlockLiquid extends Block {
   ...
   protected Vec3 getFlowVector(IBlockAccess var1, BlockPos var2) {
      ...
      if ((Integer)var1.getBlockState(var2).getValue(LEVEL) >= 8) {
         ...
         do {
            ...
            var5 = (EnumFacing)var6.next();
            var7 = var2.offset(var5);
         } while(!this.isBlockSolid(var1, var7, var5) && !this.isBlockSolid(var1, var7.up(), var5));
   ...
   public int tickRate(World var1) {
      if (this.blockMaterial == Material.water) {
         ...
         return var1.provider.getHasNoSky() ? 10 : 30;
      } else {
         return 0;
      }
   }
   ...
   public static double getFlowDirection(IBlockAccess var0, BlockPos var1, Material var2) {
      ...
      return var3.xCoord == 0.0D && var3.zCoord == 0.0D ? -1000.0D : MathHelper.atan2(var3.zCoord, var3.xCoord) - 1.5707963267948966D;
   }
   ...
   public boolean shouldSideBeRendered(IBlockAccess var1, BlockPos var2, EnumFacing var3) {
      if (var1.getBlockState(var2).getBlock().getMaterial() == this.blockMaterial) {
         return false;
      } else {
