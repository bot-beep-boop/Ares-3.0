...
public abstract class BlockButton extends Block {
   ...
   public boolean canPlaceBlockAt(World var1, BlockPos var2) {
      ...
      for(int var4 = 0; var4 < var5; ++var4) {
         ...
         if (func_181088_a(var1, var2, var3)) {
            return true;
         }
      }
   ...
   public int getStrongPower(IBlockAccess var1, BlockPos var2, IBlockState var3, EnumFacing var4) {
      if (!(Boolean)var3.getValue(POWERED)) {
         ...
         return var3.getValue(FACING) == var4 ? 15 : 0;
      }
   }
   ...
   public IBlockState onBlockPlaced(World var1, BlockPos var2, EnumFacing var3, float var4, float var5, float var6, int var7, EntityLivingBase var8) {
      return func_181088_a(var1, var2, var3.getOpposite()) ? this.getDefaultState().withProperty(FACING, var3).withProperty(POWERED, false) : this.getDefaultState().withProperty(FACING, EnumFacing.DOWN).withProperty(POWERED, false);
   }
