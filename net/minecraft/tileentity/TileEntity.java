...
public abstract class TileEntity {
   ...
   public void addInfoToCrashReport(CrashReportCategory var1) {
      var1.addCrashSectionCallable("Name", new Callable<String>(this) {
      ...
      if (this.worldObj != null) {
         ...
         var1.addCrashSectionCallable("Actual block type", new Callable<String>(this) {
            final TileEntity this$0;
         ...
         var1.addCrashSectionCallable("Actual block data value", new Callable<String>(this) {
            final TileEntity this$0;
