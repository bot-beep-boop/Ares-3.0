      ...
      for(var4 = 0; var4 < 4; ++var4) {
         this.addSlotToContainer(new Slot(this, var1, var1.getSizeInventory() - 1 - var4, 8, 8 + var4 * 18, var4) {
            ...
            public String getSlotTexture() {
               return ItemArmor.EMPTY_SLOT_NAMES[this.val$j1];
            }
            ...
            public boolean isItemValid(ItemStack var1) {
               if (var1 == null) {
                  ...
                  return ((ItemArmor)var1.getItem()).armorType == this.val$j1;
               } else if (var1.getItem() != Item.getItemFromBlock(Blocks.pumpkin) && var1.getItem() != Items.skull) {
                  return false;
               } else {
                  return this.val$j1 == 0;
               }
            }
