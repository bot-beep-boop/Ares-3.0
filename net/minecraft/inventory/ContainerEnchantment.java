...
public class ContainerEnchantment extends Container {
               ...
               for(var4 = 0; var4 < 3; ++var4) {
                  if (this.enchantLevels[var4] > 0) {
                     ...
                     if (var7 != null && !var7.isEmpty()) {
                        ...
                        this.enchantmentIds[var4] = var6.enchantmentobj.effectId | var6.enchantmentLevel << 8;
                     }
                  }
               }
   ...
   public boolean canInteractWith(EntityPlayer var1) {
      if (this.worldPointer.getBlockState(this.position).getBlock() != Blocks.enchanting_table) {
         ...
         return !(var1.getDistanceSq((double)this.position.getX() + 0.5D, (double)this.position.getY() + 0.5D, (double)this.position.getZ() + 0.5D) > 64.0D);
      }
   }
