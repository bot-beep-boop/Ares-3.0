...
public class ContainerRepair extends Container {
            ...
            if (var12.isItemStackDamageable() && var12.getItem().getIsRepairable(var8, var13)) {
               ...
               while(true) {
                  ...
                  do {
                     ...
                     var17 = (Integer)var28.next();
                     var29 = Enchantment.getEnchantmentById(var17);
                  } while(var29 == null);

                  var20 = var14.containsKey(var17) ? (Integer)var14.get(var17) : 0;
                  int var21 = (Integer)var27.get(var17);
                  int var22;
                  if (var20 == var21) {
                     ++var21;
                     var22 = var21;
                  ...
                  Iterator var25 = var14.keySet().iterator();

                  int var24;
                  while(var25.hasNext()) {
                     var24 = (Integer)var25.next();
                     if (var24 != var17 && !var29.canApplyTogether(Enchantment.getEnchantmentById(var24))) {
                        var23 = false;
                        ++var9;
                     }
                  }
   ...
   public boolean canInteractWith(EntityPlayer var1) {
      if (this.theWorld.getBlockState(this.selfPosition).getBlock() != Blocks.anvil) {
         ...
         return !(var1.getDistanceSq((double)this.selfPosition.getX() + 0.5D, (double)this.selfPosition.getY() + 0.5D, (double)this.selfPosition.getZ() + 0.5D) > 64.0D);
      }
   }
         ...
         public void onPickupFromSlot(EntityPlayer var1, ItemStack var2) {
            ...
            if (!var1.capabilities.isCreativeMode && !this.val$worldIn.isRemote && var5.getBlock() == Blocks.anvil && var1.getRNG().nextFloat() < 0.12F) {
               ...
               if (var4 > 2) {
                  ...
                  this.val$worldIn.setBlockState(this.val$blockPosIn, var5.withProperty(BlockAnvil.DAMAGE, var4), 2);
