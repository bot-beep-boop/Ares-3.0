...
public class PotionHelper {
            ...
            if (var5 >= 0 && var5 < var2) {
               ...
               for(int var15 = var1; var15 < var2; ++var15) {
                  ...
                  if (var16 >= '0' && var16 <= '9') {
                     ...
                     if (var8) {
                        var14 += getPotionEffect(var9, var7, var10, var11, var12, var13, var3);
                        var9 = false;
                        var10 = false;
                        var6 = false;
                        var7 = false;
   ...
   public static int getLiquidColor(int var0, boolean var1) {
      Integer var2 = IntegerCache.getInteger(var0);
      if (!var1) {
   ...
   public static int getPotionPrefixIndexFlags(int var0, int var1, int var2, int var3, int var4, int var5) {
   ...
   public static List<PotionEffect> getPotionEffects(int var0, boolean var1) {
      ArrayList var2 = null;
      Potion[] var6;
   ...
   public static int calcPotionLiquidColor(Collection<PotionEffect> var0) {
      int var1 = 3694022;
      if (var0 != null && !var0.isEmpty()) {
         ...
         while(true) {
            ...
            do {
               ...
               var6 = (PotionEffect)var7.next();
            } while(!var6.getIsShowParticles());

            int var8 = Potion.potionTypes[var6.getPotionID()].getLiquidColor();
            if (Config.isCustomColors()) {
               var8 = CustomColors.getPotionColor(var6.getPotionID(), var8);
            }

            for(int var9 = 0; var9 <= var6.getAmplifier(); ++var9) {
         ...
         return Config.isCustomColors() ? CustomColors.getPotionColor(0, var1) : var1;
      }
   }

   private static int getPotionEffect(boolean var0, boolean var1, boolean var2, int var3, int var4, int var5, int var6) {
      int var7 = 0;
      if (var0) {
   ...
   public static int getPotionPrefixIndex(int var0) {
      return getPotionPrefixIndexFlags(var0, 5, 4, 3, 2, 1);
   }
   ...
   public static boolean getAreAmbient(Collection<PotionEffect> var0) {
      Iterator var2 = var0.iterator();

      while(var2.hasNext()) {
         PotionEffect var1 = (PotionEffect)var2.next();
         if (!var1.getIsAmbient()) {
            return false;
         }
      }
