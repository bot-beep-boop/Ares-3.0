...
public class CrashReportCategory {
   ...
   public static void addBlockInfo(CrashReportCategory var0, BlockPos var1, IBlockState var2) {
      var0.addCrashSectionCallable("Block", new Callable<String>(var2) {
      ...
      var0.addCrashSectionCallable("Block location", new Callable<String>(var1) {
   ...
   public static void addBlockInfo(CrashReportCategory var0, BlockPos var1, Block var2, int var3) {
      ...
      var0.addCrashSectionCallable("Block type", new Callable<String>(var4, var2) {
      ...
      var0.addCrashSectionCallable("Block data value", new Callable<String>(var3) {
