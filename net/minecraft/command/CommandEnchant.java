...
public class CommandEnchant extends CommandBase {
   ...
   public List<String> addTabCompletionOptions(ICommandSender var1, String[] var2, BlockPos var3) {
      if (var2.length == 1) {
         return getListOfStringsMatchingLastWord(var2, this.getListOfPlayers());
      } else {
         return var2.length == 2 ? getListOfStringsMatchingLastWord(var2, Enchantment.func_181077_c()) : null;
      }
   }
