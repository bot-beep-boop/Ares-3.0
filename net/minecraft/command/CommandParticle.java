...
public class CommandParticle extends CommandBase {
   public List<String> addTabCompletionOptions(ICommandSender var1, String[] var2, BlockPos var3) {
      if (var2.length == 1) {
         return getListOfStringsMatchingLastWord(var2, EnumParticleTypes.getParticleNames());
      } else if (var2.length > 1 && var2.length <= 4) {
         return func_175771_a(var2, 1, var3);
      } else {
         return var2.length == 10 ? getListOfStringsMatchingLastWord(var2, new String[]{"normal", "force"}) : null;
      }
   }
