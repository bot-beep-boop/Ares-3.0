...
public class ServerCommandManager extends CommandHandler implements IAdminCommand {
   ...
   public void notifyOperators(ICommandSender var1, ICommand var2, int var3, String var4, Object... var5) {
      ...
      if (var6) {
         Iterator var10 = var7.getConfigurationManager().getPlayerList().iterator();
         ...
         while(true) {
            ...
            do {
               ...
               var11 = var1 instanceof MinecraftServer && MinecraftServer.getServer().shouldBroadcastConsoleToOps();
               var12 = var1 instanceof RConConsoleSource && MinecraftServer.getServer().shouldBroadcastRconToOps();
