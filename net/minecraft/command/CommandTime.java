...
public class CommandTime extends CommandBase {
   ...
   public List<String> addTabCompletionOptions(ICommandSender var1, String[] var2, BlockPos var3) {
      if (var2.length == 1) {
         return getListOfStringsMatchingLastWord(var2, new String[]{"set", "add", "query"});
      } else if (var2.length == 2 && var2[0].equals("set")) {
         return getListOfStringsMatchingLastWord(var2, new String[]{"day", "night"});
      } else {
         return var2.length == 2 && var2[0].equals("query") ? getListOfStringsMatchingLastWord(var2, new String[]{"daytime", "gametime"}) : null;
      }
   }
