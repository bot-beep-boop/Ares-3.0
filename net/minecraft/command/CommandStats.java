...
public class CommandStats extends CommandBase {
   ...
   public List<String> addTabCompletionOptions(ICommandSender var1, String[] var2, BlockPos var3) {
      if (var2.length == 1) {
         return getListOfStringsMatchingLastWord(var2, new String[]{"entity", "block"});
      } else if (var2.length == 2 && var2[0].equals("entity")) {
         return getListOfStringsMatchingLastWord(var2, this.func_175776_d());
         ...
         return getListOfStringsMatchingLastWord(var2, new String[]{"set", "clear"});
      } else if ((var2.length != 4 || !var2[0].equals("entity")) && (var2.length != 6 || !var2[0].equals("block"))) {
         return var2.length == 6 && var2[0].equals("entity") || var2.length == 8 && var2[0].equals("block") ? getListOfStringsMatchingLastWord(var2, this.func_175777_e()) : null;
      } else {
         return getListOfStringsMatchingLastWord(var2, CommandResultStats.Type.getTypeNames());
      }
   }
      ...
      if (var2.length < 1) {
         ...
         if (var6 == null) {
            ...
            if (var3) {
               ...
               Entity var12 = getEntity(var1, var2[1]);
            ...
            if ("set".equals(var5)) {
               ...
               CommandResultStats.setScoreBoardStat(var8, var6, var13, var14);
