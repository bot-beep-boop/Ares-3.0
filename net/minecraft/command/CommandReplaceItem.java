...
public class CommandReplaceItem extends CommandBase {
   ...
   public List<String> addTabCompletionOptions(ICommandSender var1, String[] var2, BlockPos var3) {
      if (var2.length == 1) {
         ...
         return getListOfStringsMatchingLastWord(var2, this.getUsernames());
         ...
         return getListOfStringsMatchingLastWord(var2, SHORTCUTS.keySet());
      } else {
         return var2.length == 4 && var2[0].equals("entity") || var2.length == 6 && var2[0].equals("block") ? getListOfStringsMatchingLastWord(var2, Item.itemRegistry.getKeys()) : null;
      }
   }
