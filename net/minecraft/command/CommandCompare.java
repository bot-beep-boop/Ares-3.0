...
public class CommandCompare extends CommandBase {
               ...
               for(int var14 = var6.minZ; var14 <= var6.maxZ; ++var14) {
                  for(int var15 = var6.minY; var15 <= var6.maxY; ++var15) {
                     for(int var16 = var6.minX; var16 <= var6.maxX; ++var16) {
                        var12.set(var16, var15, var14);
                        var13.set(var16 + var11.getX(), var15 + var11.getY(), var14 + var11.getZ());
                        boolean var17 = false;
   ...
   public List<String> addTabCompletionOptions(ICommandSender var1, String[] var2, BlockPos var3) {
      if (var2.length > 0 && var2.length <= 3) {
         ...
         return var2.length == 10 ? getListOfStringsMatchingLastWord(var2, new String[]{"masked", "all"}) : null;
      }
   }
