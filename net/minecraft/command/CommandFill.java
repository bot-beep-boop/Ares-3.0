...
public class CommandFill extends CommandBase {
   public void processCommand(ICommandSender var1, String[] var2) throws CommandException {
      if (var2.length < 7) {
         ...
         if (var9 > 32768) {
            ...
            while(var26.hasNext()) {
               BlockPos var25 = (BlockPos)var26.next();
               Block var27 = var10.getBlockState(var25).getBlock();
               var10.notifyNeighborsRespectDebug(var25, var27);
            }
   ...
   public List<String> addTabCompletionOptions(ICommandSender var1, String[] var2, BlockPos var3) {
      if (var2.length > 0 && var2.length <= 3) {
         ...
         return getListOfStringsMatchingLastWord(var2, Block.blockRegistry.getKeys());
      } else if (var2.length == 9) {
         return getListOfStringsMatchingLastWord(var2, new String[]{"replace", "destroy", "keep", "hollow", "outline"});
      } else {
         return var2.length == 10 && "replace".equals(var2[8]) ? getListOfStringsMatchingLastWord(var2, Block.blockRegistry.getKeys()) : null;
      }
   }
}
