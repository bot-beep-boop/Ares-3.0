...
public class PlayerSelector {
   ...
   private static <T extends Entity> List<T> func_179658_a(List<T> var0, Map<String, String> var1, ICommandSender var2, Class<? extends T> var3, String var4, BlockPos var5) {
      ...
      if (!var4.equals("p") && !var4.equals("a") && !var4.equals("e")) {
         ...
         Collections.sort((List)var0, new Comparator<Entity>(var5) {
   ...
   private static boolean func_179665_h(Map<String, String> var0) {
      Iterator var2 = WORLD_BINDING_ARGS.iterator();
   ...
   private static List<Predicate<Entity>> getXpLevelPredicates(Map<String, String> var0) {
      ...
      if (var2 > -1 || var3 > -1) {
         var1.add(new Predicate<Entity>(var2, var3) {
         ...
         var1.add(new Predicate<Entity>(var2, var3) {
            ...
            public boolean apply(Entity var1) {
               ...
               if (this.val$i > this.val$j) {
                  return var2 >= this.val$i || var2 <= this.val$j;
               } else {
                  return var2 >= this.val$i && var2 <= this.val$j;
               }
            }
         ...
         var1.add(new Predicate<Entity>(var2, var3) {
            ...
            public boolean apply(Entity var1) {
               ...
               if (this.val$k > this.val$l) {
                  return var2 >= this.val$k || var2 <= this.val$l;
               } else {
                  return var2 >= this.val$k && var2 <= this.val$l;
               }
            }
   ...
   private static Map<String, String> getArgumentMap(String var0) {
      HashMap var1 = Maps.newHashMap();
      if (var0 == null) {
         return var1;
      } else {
         ...
         var1.add(new Predicate<Entity>(var2, var3) {
            ...
            public boolean apply(Entity var1) {
               if (!(var1 instanceof EntityLivingBase)) {
                  ...
                  return var4.equals(this.val$ss) ^ this.val$flag;
               }
            }
   ...
   private static List<Predicate<Entity>> getScorePredicates(Map<String, String> var0) {
      ArrayList var1 = Lists.newArrayList();
      Map var2 = func_96560_a(var0);
      if (var2 != null && var2.size() > 0) {
         var1.add(new Predicate<Entity>(var2) {
   ...
   private static int parseIntWithDefault(Map<String, String> var0, String var1, int var2) {
         ...
         if (!isEntityTypeValid(var0, var4)) {
            ...
            while(var10.hasNext()) {
               ...
               if (var9 != null) {
                  ...
                  var11.addAll(getTeamPredicates(var4));
                  var11.addAll(getScorePredicates(var4));
                  var11.addAll(getNamePredicates(var4));
   ...
   private static List<Predicate<Entity>> func_179663_a(Map<String, String> var0, String var1) {
      ...
      if ((var3 == null || !var1.equals("e")) && !var6) {
         ...
         var2.add(new Predicate<Entity>(var3, var4) {
            private final boolean val$flag;
            private final String val$ss;

            public boolean apply(Entity var1) {
               return EntityList.isStringEntityName(var1, this.val$ss) ^ this.val$flag;
            }
   ...
   private static <T extends Entity> List<T> filterResults(Map<String, String> var0, Class<? extends T> var1, List<Predicate<Entity>> var2, String var3, World var4, BlockPos var5) {
      ...
      if (var5 != null) {
         ...
         if (!var0.containsKey("dx") && !var0.containsKey("dy") && !var0.containsKey("dz")) {
            ...
            if (var8 && var18 && !var9) {
               Predicate var20 = new Predicate<Entity>(var19) {
                  ...
                  public boolean apply(Entity var1) {
                     if (!(var1.posX < this.val$axisalignedbb.minX) && !(var1.posY < this.val$axisalignedbb.minY) && !(var1.posZ < this.val$axisalignedbb.minZ)) {
                        return !(var1.posX >= this.val$axisalignedbb.maxX) && !(var1.posY >= this.val$axisalignedbb.maxY) && !(var1.posZ >= this.val$axisalignedbb.maxZ);
                     } else {
                        return false;
                     }
                  }
   ...
   private static List<Predicate<Entity>> func_180698_a(Map<String, String> var0, BlockPos var1) {
      ArrayList var2 = Lists.newArrayList();
      ...
      if (var1 != null && (var3 >= 0 || var4 >= 0)) {
         int var5 = var3 * var3;
         int var6 = var4 * var4;
         var2.add(new Predicate<Entity>(var1, var3, var5, var4, var6) {
            private final int val$i;
            private final int val$j;
   ...
   private static List<Predicate<Entity>> getNamePredicates(Map<String, String> var0) {
      ...
      if (var2 != null) {
         var1.add(new Predicate<Entity>(var2, var3) {
            ...
            public boolean apply(Entity var1) {
               return var1.getName().equals(this.val$ss) ^ this.val$flag;
            }
         });
      }
