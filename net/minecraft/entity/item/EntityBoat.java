...
public class EntityBoat extends Entity {
   ...
   protected void updateFallState(double var1, boolean var3, Block var4, BlockPos var5) {
      ...
      } else if (this.worldObj.getBlockState((new BlockPos(this)).down()).getBlock().getMaterial() != Material.water && var1 < 0.0D) {
      ...
      if (this.isEntityInvulnerable(var1)) {
         ...
         if (this.riddenByEntity != null && this.riddenByEntity == var1.getEntity() && var1 instanceof EntityDamageSourceIndirect) {
            ...
            if (var3 || this.getDamageTaken() > 40.0F) {
               ...
               if (!var3 && this.worldObj.getGameRules().getBoolean("doEntityDrops")) {
   ...
   public void onUpdate() {
      ...
      if (this.worldObj.isRemote && this.isBoatEmpty) {
         ...
         if (this.riddenByEntity instanceof EntityLivingBase) {
            ...
            this.motionX += -Math.sin((double)(var21 * 3.1415927F / 180.0F)) * this.speedMultiplier * (double)var20.moveForward * 0.05000000074505806D;
            this.motionZ += Math.cos((double)(var21 * 3.1415927F / 180.0F)) * this.speedMultiplier * (double)var20.moveForward * 0.05000000074505806D;
         }
         ...
         if (var24 * var24 + var26 * var26 > 0.001D) {
            var8 = (double)((float)(MathHelper.atan2(var26, var24) * 180.0D / 3.141592653589793D));
         }
