...
public class EntityIronGolem extends EntityGolem {
   ...
   public boolean canAttackClass(Class<? extends EntityLivingBase> var1) {
      if (this.isPlayerCreated() && EntityPlayer.class.isAssignableFrom(var1)) {
         return false;
      } else {
         return var1 == EntityCreeper.class ? false : super.canAttackClass(var1);
      }
   }
   ...
   static class AINearestAttackableTargetNonCreeper<T extends EntityLivingBase> extends EntityAINearestAttackableTarget<T> {
      ...
      public AINearestAttackableTargetNonCreeper(EntityCreature var1, Class<T> var2, int var3, boolean var4, boolean var5, Predicate<? super T> var6) {
         super(var1, var2, var3, var4, var5, var6);
         this.targetEntitySelector = new Predicate<T>(this, var6, var1) {
