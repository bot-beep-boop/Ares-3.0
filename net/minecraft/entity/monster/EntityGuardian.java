   ...
   protected void updateAITasks() {
      ...
      if (this.isElder()) {
         ...
         if ((this.ticksExisted + this.getEntityId()) % 1200 == 0) {
            ...
            Iterator var7 = this.worldObj.getPlayers(EntityPlayerMP.class, new Predicate<EntityPlayerMP>(this) {
   ...
   static class GuardianMoveHelper extends EntityMoveHelper {
      ...
      public void onUpdateMoveHelper() {
         if (this.update && !this.entityGuardian.getNavigator().noPath()) {
            ...
            var3 /= var7;
            float var9 = (float)(MathHelper.atan2(var5, var1) * 180.0D / 3.1415927410125732D) - 90.0F;
