...
public class EntityEnderman extends EntityMob {
   ...
   public EntityEnderman(World var1) {
      ...
      this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityEndermite.class, 10, true, false, new Predicate<EntityEndermite>(this) {
   ...
   static class AIPlaceBlock extends EntityAIBase {
      ...
      private boolean func_179474_a(World var1, BlockPos var2, Block var3, Block var4, Block var5) {
         if (!var3.canPlaceBlockAt(var1, var2)) {
            return false;
         } else if (var4.getMaterial() != Material.air) {
            return false;
         } else {
            return var5.getMaterial() == Material.air ? false : var5.isFullCube();
         }
      }
