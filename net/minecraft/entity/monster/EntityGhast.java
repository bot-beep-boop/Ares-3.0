      ...
      public void updateTask() {
         if (this.parentEntity.getAttackTarget() == null) {
            ...
            if (var1.getDistanceSqToEntity(this.parentEntity) < var2 * var2) {
               ...
               this.parentEntity.renderYawOffset = this.parentEntity.rotationYaw = -((float)MathHelper.atan2(var4, var6)) * 180.0F / 3.1415927F;
            }
         }
         ...
         if (this.update) {
            ...
            if (this.courseChangeCooldown-- <= 0) {
               ...
               if (this.isNotColliding(this.posX, this.posY, this.posZ, var7)) {
                  EntityGhast var10000 = this.parentEntity;
