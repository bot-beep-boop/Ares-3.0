...
public abstract class Entity implements ICommandSender {
   ...
   protected boolean pushOutOfBlocks(double var1, double var3, double var5) {
      ...
      List var14 = this.worldObj.getCollisionBoxes(this.getEntityBoundingBox());
   ...
   public void addEntityCrashInfo(CrashReportCategory var1) {
      var1.addCrashSectionCallable("Entity Type", new Callable<String>(this) {
         final Entity this$0;
      ...
      var1.addCrashSectionCallable("Entity Name", new Callable<String>(this) {
         final Entity this$0;
      ...
      var1.addCrashSectionCallable("Entity's Rider", new Callable<String>(this) {
         final Entity this$0;
      ...
      var1.addCrashSectionCallable("Entity's Vehicle", new Callable<String>(this) {
         final Entity this$0;
   ...
   public void setPortal(BlockPos var1) {
      if (this.timeUntilPortal > 0) {
         ...
         if (!this.worldObj.isRemote && !var1.equals(this.lastPortalPos)) {
            this.lastPortalPos = var1;
            BlockPattern.PatternHelper var2 = Blocks.portal.func_181089_f(this.worldObj, var1);
            double var3 = var2.getFinger().getAxis() == EnumFacing.Axis.X ? (double)var2.getPos().getZ() : (double)var2.getPos().getX();
            ...
            double var7 = MathHelper.func_181160_c(this.posY - 1.0D, (double)var2.getPos().getY(), (double)(var2.getPos().getY() - var2.func_181119_e()));
            this.lastPortalVec = new Vec3(var5, var7, 0.0D);
            this.teleportDirection = var2.getFinger();
         }
