         ...
         if (this.interactionDelay == 0) {
            ...
            for(int var2 = 0; var2 < var1.getSizeInventory(); ++var2) {
               ...
               if (var4 != null) {
                  ...
                  var12.motionX = (double)(-MathHelper.sin(var9 / 180.0F * 3.1415927F) * MathHelper.cos(var10 / 180.0F * 3.1415927F) * var8);
                  var12.motionZ = (double)(MathHelper.cos(var9 / 180.0F * 3.1415927F) * MathHelper.cos(var10 / 180.0F * 3.1415927F) * var8);
                  var12.motionY = (double)(-MathHelper.sin(var10 / 180.0F * 3.1415927F) * var8 + 0.1F);
