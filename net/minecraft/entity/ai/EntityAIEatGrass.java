...
public class EntityAIEatGrass extends EntityAIBase {
   ...
   static {
      field_179505_b = BlockStateHelper.forBlock(Blocks.tallgrass).where(BlockTallGrass.TYPE, Predicates.equalTo(BlockTallGrass.EnumType.GRASS));
   }
   ...
   public boolean shouldExecute() {
      if (this.grassEaterEntity.getRNG().nextInt(this.grassEaterEntity.isChild() ? 50 : 1000) != 0) {
         ...
         if (field_179505_b.apply(this.entityWorld.getBlockState(var1))) {
            ...
            return this.entityWorld.getBlockState(var1.down()).getBlock() == Blocks.grass;
         }
      }
   }
}
