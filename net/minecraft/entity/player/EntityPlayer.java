...
import com.aresclient.user.cosmetic.CosmeticBase;
...
public abstract class EntityPlayer extends EntityLivingBase {
   ...
   public CosmeticBase cosmeticbase;
      ...
      if (!this.isEntityInvulnerable(var1)) {
         ...
         if (var3 != 0.0F) {
            ...
            if (var3 < 3.4028235E37F) {
               this.addStat(StatList.damageTakenStat, Math.round(var3 * 10.0F));
            }
         }
      }
      ...
      if (var1.canAttackWithItem() && !var1.hitByEntity(this)) {
         ...
         if (var2 > 0.0F || var4 > 0.0F) {
            ...
            if (var14) {
               ...
               if (ConfigManager.settings.Particle == 2) {
   ...
   public boolean canAttackPlayer(EntityPlayer var1) {
      ...
      if (var2 == null) {
         ...
         return !var2.isSameTeam(var3) ? true : var2.getAllowFriendlyFire();
      }
   }
