...
public class EntityPlayerMP extends EntityPlayer implements ICrafting {
   ...
   public void onUpdateEntity() {
      try {
         ...
         if (this.getHealth() + this.getAbsorptionAmount() != this.combinedHealth) {
            ...
            Iterator var7 = this.getWorldScoreboard().getObjectivesFromCriteria(IScoreObjectiveCriteria.health).iterator();

            while(var7.hasNext()) {
               ScoreObjective var5 = (ScoreObjective)var7.next();
               this.getWorldScoreboard().getValueFromObjective(this.getName(), var5).func_96651_a(Arrays.asList(this));
            }
         }
   ...
   public boolean isSpectatedByPlayer(EntityPlayerMP var1) {
      if (var1.isSpectator()) {
         ...
         return this.isSpectator() ? false : super.isSpectatedByPlayer(var1);
      }
   }
   ...
   public void addStat(StatBase var1, int var2) {
      if (var1 != null) {
         ...
         Iterator var4 = this.getWorldScoreboard().getObjectivesFromCriteria(var1.getCriteria()).iterator();
      ...
      if ("seed".equals(var2) && !this.mcServer.isDedicatedServer()) {
         ...
         if (this.mcServer.getConfigurationManager().canSendCommands(this.getGameProfile())) {
            ...
            if (var3 != null) {
               ...
               return this.mcServer.getOpPermissionLevel() >= var1;
            }
         } else {
            return false;
         }
   ...
   public void func_175145_a(StatBase var1) {
      if (var1 != null) {
         ...
         Iterator var3 = this.getWorldScoreboard().getObjectivesFromCriteria(var1.getCriteria()).iterator();
