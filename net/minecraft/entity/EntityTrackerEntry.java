...
public class EntityTrackerEntry {
         ...
         if (this.func_180233_c(var1)) {
            if (!this.trackingPlayers.contains(var1) && (this.isPlayerWatchingThisChunk(var1) || this.trackedEntity.forceSpawn)) {
               ...
               if (this.trackedEntity instanceof EntityLivingBase) {
                  ...
                  Iterator var6 = var10.getActivePotionEffects().iterator();

                  while(var6.hasNext()) {
                     PotionEffect var11 = (PotionEffect)var6.next();
                     var1.playerNetServerHandler.sendPacket(new S1DPacketEntityEffect(this.trackedEntity.getEntityId(), var11));
                  }
               }
            }
   ...
   public void sendPacketToTrackedPlayers(Packet var1) {
      Iterator var3 = this.trackingPlayers.iterator();

      while(var3.hasNext()) {
         EntityPlayerMP var2 = (EntityPlayerMP)var3.next();
         var2.playerNetServerHandler.sendPacket(var1);
      }
   ...
   public boolean equals(Object var1) {
      if (var1 instanceof EntityTrackerEntry) {
         return ((EntityTrackerEntry)var1).trackedEntity.getEntityId() == this.trackedEntity.getEntityId();
      } else {
         return false;
      }
   }
