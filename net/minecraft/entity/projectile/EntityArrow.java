...
public class EntityArrow extends Entity implements IProjectile {
   ...
   public void setVelocity(double var1, double var3, double var5) {
      ...
      if (this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
         ...
         this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.atan2(var1, var5) * 180.0D / 3.1415927410125732D);
         this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.atan2(var3, (double)var7) * 180.0D / 3.1415927410125732D);
   ...
   public EntityArrow(World var1, EntityLivingBase var2, EntityLivingBase var3, float var4, float var5) {
      ...
      if (!(var12 < 1.0E-7D)) {
         float var14 = (float)(MathHelper.atan2(var10, var6) * 180.0D / 3.1415927410125732D) - 90.0F;
         float var15 = (float)(-(MathHelper.atan2(var8, var12) * 180.0D / 3.1415927410125732D));
   ...
   public void setThrowableHeading(double var1, double var3, double var5, float var7, float var8) {
      ...
      this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.atan2(var1, var5) * 180.0D / 3.1415927410125732D);
      this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.atan2(var3, (double)var10) * 180.0D / 3.1415927410125732D);
      this.ticksInGround = 0;
   }
   ...
   public void onUpdate() {
      ...
      if (this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
         ...
         this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.atan2(this.motionX, this.motionZ) * 180.0D / 3.1415927410125732D);
         this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.atan2(this.motionY, (double)var1) * 180.0D / 3.1415927410125732D);
      }
      ...
      if (this.inGround) {
         ...
         if (ConfigManager.settings.ArrowTrail == 1) {
            if (this.getIsCritical()) {
         ...
         } else if (ConfigManager.settings.ArrowTrail == 2) {
            for(var11 = 0; var11 < 4; ++var11) {
               this.worldObj.spawnParticle(EnumParticleTypes.HEART, this.posX + this.motionX * (double)var11 / 4.0D, this.posY + this.motionY * (double)var11 / 4.0D, this.posZ + this.motionZ * (double)var11 / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
            }
         } else if (ConfigManager.settings.ArrowTrail == 3) {
            for(var11 = 0; var11 < 4; ++var11) {
               this.worldObj.spawnParticle(EnumParticleTypes.NOTE, this.posX + this.motionX * (double)var11 / 4.0D, this.posY + this.motionY * (double)var11 / 4.0D, this.posZ + this.motionZ * (double)var11 / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
            }
         } else if (ConfigManager.settings.ArrowTrail == 4) {
            for(var11 = 0; var11 < 4; ++var11) {
               this.worldObj.spawnParticle(EnumParticleTypes.FIREWORKS_SPARK, this.posX + this.motionX * (double)var11 / 4.0D, this.posY + this.motionY * (double)var11 / 4.0D, this.posZ + this.motionZ * (double)var11 / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
            }
         }
         ...
         this.rotationYaw = (float)(MathHelper.atan2(this.motionX, this.motionZ) * 180.0D / 3.1415927410125732D);

         for(this.rotationPitch = (float)(MathHelper.atan2(this.motionY, (double)var22) * 180.0D / 3.1415927410125732D); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
         }
