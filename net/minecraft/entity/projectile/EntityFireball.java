...
public abstract class EntityFireball extends Entity {
   ...
   public void onUpdate() {
      if (this.worldObj.isRemote || (this.shootingEntity == null || !this.shootingEntity.isDead) && this.worldObj.isBlockLoaded(new BlockPos(this))) {
         ...
         this.rotationYaw = (float)(MathHelper.atan2(this.motionZ, this.motionX) * 180.0D / 3.1415927410125732D) + 90.0F;

         for(this.rotationPitch = (float)(MathHelper.atan2((double)var15, this.motionY) * 180.0D / 3.1415927410125732D) - 90.0F; this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
         }
