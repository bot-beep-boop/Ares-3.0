...
public abstract class EntityThrowable extends Entity implements IProjectile {
   ...
   public EntityLivingBase getThrower() {
      if (this.thrower == null && this.throwerName != null && this.throwerName.length() > 0) {
         ...
         if (this.thrower == null && this.worldObj instanceof WorldServer) {
            try {
               Entity var1 = ((WorldServer)this.worldObj).getEntityFromUuid(UUID.fromString(this.throwerName));
   ...
   public void onUpdate() {
      ...
      for(this.rotationPitch = (float)(MathHelper.atan2(this.motionY, (double)var16) * 180.0D / 3.1415927410125732D); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
      }
