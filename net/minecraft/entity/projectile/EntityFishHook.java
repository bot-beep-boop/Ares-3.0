   ...
   public void onUpdate() {
      ...
      if (this.fishPosRotationIncrements > 0) {
         ...
         if (!this.inGround) {
            ...
            for(this.rotationPitch = (float)(MathHelper.atan2(this.motionY, (double)var33) * 180.0D / 3.1415927410125732D); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
            }
            ...
            if (!this.worldObj.isRemote && var36 > 0.0D) {
               ...
               if (this.rand.nextFloat() < 0.25F && this.worldObj.isRainingAt(var40)) {
                  var39 = 2;
               }
