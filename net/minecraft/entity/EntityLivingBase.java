...
public abstract class EntityLivingBase extends Entity {
   ...
   public Vec3 getLook(float var1) {
      if (ConfigManager.settings.HitDelayFix == 2 && this instanceof EntityPlayerSP) {
   ...
   public void writeEntityToNBT(NBTTagCompound var1) {
      ...
      if (!this.activePotionsMap.isEmpty()) {
         ...
         while(var8.hasNext()) {
            ...
            var6.appendTag(var7.writeCustomPotionEffectToNBT(new NBTTagCompound()));
         }
      ...
      for(int var9 = -var8; var9 <= var8; ++var9) {
         for(int var10 = -var8; var10 < var8; ++var10) {
            if (var9 != 0 || var10 != 0) {
               ...
               if (this.worldObj.getCollisionBoxes(var13).isEmpty()) {
   ...
   public void onUpdate() {
      ...
      if (var5 > 0.0025000002F) {
         ...
         var6 = (float)MathHelper.atan2(var10, var9) * 180.0F / 3.1415927F - 90.0F;
      }
         ...
         if (this.getHealth() <= 0.0F) {
            ...
            if (var3) {
               ...
               if (var4 != null) {
                  ...
                  this.attackedAtYaw = (float)(MathHelper.atan2(var7, var9) * 180.0D / 3.1415927410125732D - (double)this.rotationYaw);
   ...
   protected void collideWithNearbyEntities() {
      List var1 = this.worldObj.getEntitiesInAABBexcluding(this, this.getEntityBoundingBox().expand(0.20000000298023224D, 0.0D, 0.20000000298023224D), Predicates.and(EntitySelectors.NOT_SPECTATING, new Predicate<Entity>(this) {
   ...
   protected void damageEntity(DamageSource var1, float var2) {
      if (!this.isEntityInvulnerable(var1)) {
         ...
         float var3 = Math.max(var2 - this.getAbsorptionAmount(), 0.0F);
         this.setAbsorptionAmount(this.getAbsorptionAmount() - (var2 - var3));
         if (var3 != 0.0F) {
            float var4 = this.getHealth();
            this.setHealth(var4 - var3);
            this.getCombatTracker().trackDamage(var1, var4, var3);
