   ...
   public void onLivingUpdate() {
      ...
      for(var20 = 0; var20 < 2; ++var20) {
         ...
         if (var3 != null) {
            ...
            float var18 = (float)(MathHelper.atan2(var14, var10) * 180.0D / 3.1415927410125732D) - 90.0F;
            float var19 = (float)(-(MathHelper.atan2(var12, var16) * 180.0D / 3.1415927410125732D));
      ...
      for(var21 = 0; var21 < 3; ++var21) {
         ...
         this.worldObj.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, var23 + this.rand.nextGaussian() * 0.30000001192092896D, var5 + this.rand.nextGaussian() * 0.30000001192092896D, var7 + this.rand.nextGaussian() * 0.30000001192092896D, 0.0D, 0.0D, 0.0D);
         if (var22 && this.worldObj.rand.nextInt(4) == 0) {
            this.worldObj.spawnParticle(EnumParticleTypes.SPELL_MOB, var23 + this.rand.nextGaussian() * 0.30000001192092896D, var5 + this.rand.nextGaussian() * 0.30000001192092896D, var7 + this.rand.nextGaussian() * 0.30000001192092896D, 0.699999988079071D, 0.699999988079071D, 0.5D);
         }
      }
