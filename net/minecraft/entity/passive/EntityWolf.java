...
public class EntityWolf extends EntityTameable {
   ...
   public float getTailRotation() {
      if (this.isAngry()) {
         ...
         return this.isTamed() ? (0.55F - (20.0F - this.dataWatcher.getWatchableObjectFloat(18)) * 0.02F) * 3.1415927F : 0.62831855F;
      }
   }
   ...
   public boolean isBreedingItem(ItemStack var1) {
      if (var1 == null) {
         ...
         return !(var1.getItem() instanceof ItemFood) ? false : ((ItemFood)var1.getItem()).isWolfsFavoriteMeat();
      }
   }
   ...
   public boolean shouldAttackEntity(EntityLivingBase var1, EntityLivingBase var2) {
      if (!(var1 instanceof EntityCreeper) && !(var1 instanceof EntityGhast)) {
         ...
         if (var1 instanceof EntityPlayer && var2 instanceof EntityPlayer && !((EntityPlayer)var2).canAttackPlayer((EntityPlayer)var1)) {
            return false;
         } else {
            return !(var1 instanceof EntityHorse) || !((EntityHorse)var1).isTame();
         }
      } else {
         return false;
      }
   ...
   public EntityWolf(World var1) {
      ...
      this.targetTasks.addTask(4, new EntityAITargetNonTamed(this, EntityAnimal.class, false, new Predicate<Entity>(this) {
