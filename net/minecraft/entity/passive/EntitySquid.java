...
public class EntitySquid extends EntityWaterMob {
   ...
   public void onLivingUpdate() {
      ...
      if (this.inWater) {
         ...
         this.squidPitch += (-((float)MathHelper.atan2((double)var1, this.motionY)) * 180.0F / 3.1415927F - this.squidPitch) * 0.1F;
      } else {
   ...
   static class AIMoveRandom extends EntityAIBase {
      ...
      public void updateTask() {
         ...
         } else if (this.squid.getRNG().nextInt(50) == 0 || !EntitySquid.access$0(this.squid) || !this.squid.func_175567_n()) {
