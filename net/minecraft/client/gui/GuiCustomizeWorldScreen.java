...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiPageButtonList.GuiResponder, GuiSlider.FormatHelper {
   ...
   private Predicate<String> field_175332_D = new Predicate<String>(this) {
   ...
   public void drawScreen(int var1, int var2, float var3) {
      ...
      if (this.field_175339_B != 0) {
         ...
         this.drawHorizontalLine(width / 2 - 91, width / 2 + 90, 99, -2039584);
         this.drawHorizontalLine(width / 2 - 91, width / 2 + 90, 185, -6250336);
