...
public class GuiPageButtonList extends GuiListExtended {
   ...
   private Gui func_178058_a(GuiPageButtonList.GuiListEntry var1, int var2, boolean var3) {
      if (var1 instanceof GuiPageButtonList.GuiSlideEntry) {
         return this.func_178067_a(this.width / 2 - 155 + var2, 0, (GuiPageButtonList.GuiSlideEntry)var1);
      } else if (var1 instanceof GuiPageButtonList.GuiButtonEntry) {
         return this.func_178065_a(this.width / 2 - 155 + var2, 0, (GuiPageButtonList.GuiButtonEntry)var1);
      } else if (var1 instanceof GuiPageButtonList.EditBoxEntry) {
         return this.func_178068_a(this.width / 2 - 155 + var2, 0, (GuiPageButtonList.EditBoxEntry)var1);
      } else {
         return var1 instanceof GuiPageButtonList.GuiLabelEntry ? this.func_178063_a(this.width / 2 - 155 + var2, 0, (GuiPageButtonList.GuiLabelEntry)var1, var3) : null;
      }
   }
