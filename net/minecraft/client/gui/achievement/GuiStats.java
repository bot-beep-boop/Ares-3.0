...
public class GuiStats extends GuiScreen implements IProgressMeter {
   ...
   private void drawSprite(int var1, int var2, int var3, int var4) {
      ...
      var10.pos((double)var1, (double)(var2 + 18), (double)zLevel).tex((double)((float)var3 * 0.0078125F), (double)((float)(var4 + 18) * 0.0078125F)).endVertex();
      ...
      var10.pos((double)(var1 + 18), (double)var2, (double)zLevel).tex((double)((float)(var3 + 18) * 0.0078125F), (double)((float)var4 * 0.0078125F)).endVertex();
      var10.pos((double)var1, (double)var2, (double)zLevel).tex((double)((float)var3 * 0.0078125F), (double)((float)var4 * 0.0078125F)).endVertex();
      var9.draw();
   }
