...
public class GuiKeyBindingList extends GuiListExtended {
   ...
   public GuiKeyBindingList(GuiControls var1, Minecraft var2) {
      ...
      for(int var7 = 0; var7 < var8; ++var7) {
         ...
         int var11 = var2.fontRendererObj.getStringWidth(I18n.format(var6.getKeyDescription()));
   ...
   public class KeyEntry implements GuiListExtended.IGuiListEntry {
      ...
      public void drawEntry(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8) {
         ...
         GuiKeyBindingList.access$0(this.this$0).fontRendererObj.drawString(this.keyDesc, var2 + 90 - GuiKeyBindingList.access$2(this.this$0), var3 + var5 / 2 - GuiKeyBindingList.access$0(this.this$0).fontRendererObj.FONT_HEIGHT / 2, 16777215);
   ...
   public class CategoryEntry implements GuiListExtended.IGuiListEntry {
      ...
      public void drawEntry(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8) {
         FontRenderer var10000 = GuiKeyBindingList.access$0(this.this$0).fontRendererObj;
         String var10001 = this.labelText;
         GuiScreen var10002 = GuiKeyBindingList.access$0(this.this$0).currentScreen;
         var10000.drawString(var10001, GuiScreen.width / 2 - this.labelWidth / 2, var3 + var5 - GuiKeyBindingList.access$0(this.this$0).fontRendererObj.FONT_HEIGHT - 1, 16777215);
      }
