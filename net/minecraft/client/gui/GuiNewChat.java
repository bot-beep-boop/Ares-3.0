...
public class GuiNewChat extends Gui {
   ...
   private void setChatLine(IChatComponent var1, int var2, int var3, boolean var4) {
      ...
      IChatComponent var8;
      for(Iterator var9 = var6.iterator(); var9.hasNext(); this.drawnChatLines.add(0, new ChatLine(var3, var8, var2))) {
               ...
               if (var9 >= 0 && var9 < this.drawnChatLines.size()) {
                  ...
                  while(var13.hasNext()) {
                     ...
                     if (var12 instanceof ChatComponentText) {
                        var11 += this.mc.fontRendererObj.getStringWidth(GuiUtilRenderComponents.func_178909_a(((ChatComponentText)var12).getChatComponentText_TextValue(), false));
                        if (var11 > var6) {
                           return var12;
                        }
                     }
