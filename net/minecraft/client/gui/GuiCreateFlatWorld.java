...
public class GuiCreateFlatWorld extends GuiScreen {
   ...
   class Details extends GuiSlot {
      ...
      private void func_148224_c(int var1, int var2, int var3, int var4) {
         ...
         var10.pos((double)var1, (double)(var2 + 18), (double)GuiCreateFlatWorld.zLevel).tex((double)((float)var3 * 0.0078125F), (double)((float)(var4 + 18) * 0.0078125F)).endVertex();
         var10.pos((double)(var1 + 18), (double)(var2 + 18), (double)GuiCreateFlatWorld.zLevel).tex((double)((float)(var3 + 18) * 0.0078125F), (double)((float)(var4 + 18) * 0.0078125F)).endVertex();
         var10.pos((double)(var1 + 18), (double)var2, (double)GuiCreateFlatWorld.zLevel).tex((double)((float)(var3 + 18) * 0.0078125F), (double)((float)var4 * 0.0078125F)).endVertex();
         var10.pos((double)var1, (double)var2, (double)GuiCreateFlatWorld.zLevel).tex((double)((float)var3 * 0.0078125F), (double)((float)var4 * 0.0078125F)).endVertex();
         var9.draw();
      }
      ...
      public Details(GuiCreateFlatWorld var1) {
         super(var1.mc, GuiCreateFlatWorld.width, GuiCreateFlatWorld.height, 43, GuiCreateFlatWorld.height - 60, 24);
         this.this$0 = var1;
      ...
      protected void drawSlot(int var1, int var2, int var3, int var4, int var5, int var6) {
         ...
         this.this$0.fontRendererObj.drawString(var12, var2 + 18 + 5, var3 + 3, 16777215);
         String var13;
         if (var1 == 0) {
         ...
         this.this$0.fontRendererObj.drawString(var13, var2 + 2 + 213 - this.this$0.fontRendererObj.getStringWidth(var13), var3 + 3, 16777215);
      }
      ...
      private void func_148225_a(int var1, int var2, ItemStack var3) {
         ...
         if (var3 != null && var3.getItem() != null) {
            ...
            this.this$0.itemRender.renderItemIntoGUI(var3, var1 + 2, var2 + 2);
