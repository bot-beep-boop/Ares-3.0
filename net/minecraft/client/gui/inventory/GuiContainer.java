         ...
         if (isShiftKeyDown()) {
            if (var4 != null && var4.inventory != null && this.shiftClickedSlot != null) {
               ...
               while(var10.hasNext()) {
                  ...
                  if (var11 != null && var11.canTakeStack(this.mc.thePlayer) && var11.getHasStack() && var11.inventory == var4.inventory && Container.canAddItemToSlot(var11, this.shiftClickedSlot, true)) {
