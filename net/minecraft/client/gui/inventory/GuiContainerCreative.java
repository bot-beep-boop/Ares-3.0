...
public class GuiContainerCreative extends InventoryEffectRenderer {
   ...
   private void updateCreativeSearch() {
      ...
      while(var9.hasNext()) {
         ...
         boolean var13 = false;
         Iterator var7 = var12.getTooltip(this.mc.thePlayer, this.mc.gameSettings.advancedItemTooltips).iterator();
   ...
   protected void mouseClicked(int var1, int var2, int var3) throws IOException {
      if (var3 == 0) {
         ...
         for(int var7 = 0; var7 < var8; ++var7) {
            ...
            if (this.func_147049_a(var6, var4, var5)) {
               return;
            }
         }
      }
   ...
   public void drawScreen(int var1, int var2, float var3) {
      ...
      for(int var12 = 0; var12 < var13; ++var12) {
         ...
         if (this.renderCreativeInventoryHoveringText(var11, var1, var2)) {
            break;
         }
      }
   ...
   public void handleMouseInput() throws IOException {
      ...
      if (var1 != 0 && this.needsScrollBars()) {
         int var2 = ((GuiContainerCreative.ContainerCreative)this.inventorySlots).itemList.size() / 9 - 5;
         if (var1 > 0) {
            var1 = 1;
         }
   ...
   protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
      ...
      if (var4.shouldHidePlayerInventory()) {
         drawTexturedModalRect(var9, var6 + (int)((float)(var7 - var6 - 17) * this.currentScroll), 232 + (this.needsScrollBars() ? 0 : 12), 0, 12, 15);
      }
