...
public class GuiFlatPresets extends GuiScreen {
   ...
   class ListSlot extends GuiSlot {
      ...
      private void func_148171_c(int var1, int var2, int var3, int var4) {
         ...
         var10.pos((double)var1, (double)(var2 + 18), (double)GuiFlatPresets.zLevel).tex((double)((float)var3 * 0.0078125F), (double)((float)(var4 + 18) * 0.0078125F)).endVertex();
         ...
         var10.pos((double)(var1 + 18), (double)var2, (double)GuiFlatPresets.zLevel).tex((double)((float)(var3 + 18) * 0.0078125F), (double)((float)var4 * 0.0078125F)).endVertex();
         var10.pos((double)var1, (double)var2, (double)GuiFlatPresets.zLevel).tex((double)((float)var3 * 0.0078125F), (double)((float)var4 * 0.0078125F)).endVertex();
         var9.draw();
      }
      ...
      protected void drawSlot(int var1, int var2, int var3, int var4, int var5, int var6) {
         ...
         this.this$0.fontRendererObj.drawString(var7.field_148232_b, var2 + 18 + 5, var3 + 6, 16777215);
      }
