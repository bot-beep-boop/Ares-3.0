               ...
               if (var6 >= 0 && var6 < this.field_175386_A.size()) {
                  ...
                  while(var10.hasNext()) {
                     ...
                     if (var9 instanceof ChatComponentText) {
                        var8 += this.mc.fontRendererObj.getStringWidth(((ChatComponentText)var9).getChatComponentText_TextValue());
                        if (var8 > var3) {
                           return var9;
                        }
                     }
         ...
         if (this.bookIsUnsigned) {
            ...
            if (ItemEditableBook.validBookTagContents(this.bookObj.getTagCompound())) {
               try {
                  ...
                  this.field_175386_A = var14 != null ? GuiUtilRenderComponents.splitText(var14, 116, this.fontRendererObj, true, true) : null;
