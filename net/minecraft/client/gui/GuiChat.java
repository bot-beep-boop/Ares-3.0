...
import com.aresclient.visuals.GuiQuickSearch;
...
public class GuiChat extends GuiScreen {
   ...
   protected void actionPerformed(GuiButton var1) throws IOException {
      if (var1.id == 1) {
         this.mc.displayGuiScreen(new GuiQuickSearch());
      }
   ...
   public void initGui() {
      ...
      if (Minecraft.getMinecraft().getCurrentServerData() != null && Minecraft.getMinecraft().getCurrentServerData().serverIP.contains("hypixel") && !Minecraft.getMinecraft().isSingleplayer()) {
         this.buttonList.add(new ImageButtonWithText(1, width - (var1 + var1 / 2), 10, var1, var1, new ResourceLocation("Ares/Icons/QuickSearch/H.png"), "Hypixel QuickSearch", ""));
      }
