...
public class GuiSpectator extends Gui implements ISpectatorMenuRecipient {
   ...
   private void func_175266_a(int var1, int var2, float var3, float var4, ISpectatorMenuObject var5) {
      ...
      if (var5 != SpectatorMenu.field_178657_a) {
         ...
         if (var6 > 3 && var5.func_178662_A_()) {
            this.field_175268_g.fontRendererObj.drawStringWithShadow(var8, (float)(var2 + 19 - 2 - this.field_175268_g.fontRendererObj.getStringWidth(var8)), var3 + 6.0F + 3.0F, 16777215 + (var6 << 24));
         }
      }
   ...
   public void renderSelectedItem(ScaledResolution var1) {
      ...
      if (var2 > 3 && this.field_175271_i != null) {
         ...
         if (var4 != null) {
            int var5 = (var1.getScaledWidth() - this.field_175268_g.fontRendererObj.getStringWidth(var4)) / 2;
