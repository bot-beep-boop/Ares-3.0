...
public class GuiScreenCustomizePresets extends GuiScreen {
   ...
   class ListPreset extends GuiSlot {
      ...
      private void func_178051_a(int var1, int var2, ResourceLocation var3) {
         ...
         var8.pos((double)var4, (double)(var2 + 32), 0.0D).tex(0.0D, 1.0D).endVertex();
         var8.pos((double)(var4 + 32), (double)(var2 + 32), 0.0D).tex(1.0D, 1.0D).endVertex();
         var8.pos((double)(var4 + 32), (double)var2, 0.0D).tex(1.0D, 0.0D).endVertex();
         var8.pos((double)var4, (double)var2, 0.0D).tex(0.0D, 0.0D).endVertex();
         var7.draw();
      }
      ...
      protected void drawSlot(int var1, int var2, int var3, int var4, int var5, int var6) {
         ...
         this.this$0.fontRendererObj.drawString(var7.field_178955_a, var2 + 32 + 10, var3 + 14, 16777215);
      }
