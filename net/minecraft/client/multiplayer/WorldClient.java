...
public class WorldClient extends World {
   ...
   public CrashReportCategory addWorldInfoToCrashReport(CrashReport var1) {
      ...
      var2.addCrashSectionCallable("Forced entities", new Callable<String>(this) {
      ...
      var2.addCrashSectionCallable("Retry entities", new Callable<String>(this) {
         final WorldClient this$0;
      ...
      var2.addCrashSectionCallable("Server brand", new Callable<String>(this) {
         final WorldClient this$0;
      ...
      var2.addCrashSectionCallable("Server type", new Callable<String>(this) {
         final WorldClient this$0;
