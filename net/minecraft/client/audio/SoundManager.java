...
public class SoundManager {
   ...
   public void pauseAllSounds() {
      ...
      while(var2.hasNext()) {
         ...
         logger.debug(LOG_MARKER, "Pausing channel {}", new Object[]{var1});
   ...
   public void resumeAllSounds() {
      ...
      while(var2.hasNext()) {
         String var1 = (String)var2.next();
         logger.debug(LOG_MARKER, "Resuming channel {}", new Object[]{var1});
   ...
   public boolean isSoundPlaying(ISound var1) {
      if (!this.loaded) {
         ...
         if (var2 == null) {
            ...
            return this.sndSystem.playing(var2) || this.playingSoundsStopTime.containsKey(var2) && (Integer)this.playingSoundsStopTime.get(var2) <= this.playTime;
         }
      }
   }
