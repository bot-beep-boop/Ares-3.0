   ...
   public void doRenderLayer(EntityLivingBase var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      ...
      if (var9 > 0) {
         ...
         for(int var12 = 0; var12 < var9; ++var12) {
            ...
            var10.prevRotationYaw = var10.rotationYaw = (float)(Math.atan2((double)var15, (double)var17) * 180.0D / 3.1415927410125732D);
            var10.prevRotationPitch = var10.rotationPitch = (float)(Math.atan2((double)var16, (double)var21) * 180.0D / 3.1415927410125732D);
            double var22 = 0.0D;
            double var24 = 0.0D;
            double var26 = 0.0D;
