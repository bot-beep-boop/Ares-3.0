...
public class RenderItem implements IResourceManagerReloadListener {
   ...
   public void renderItemAndEffectIntoGUI(ItemStack var1, int var2, int var3) {
      if (var1 != null && var1.getItem() != null) {
         ...
         try {
            this.renderItemIntoGUI(var1, var2, var3);
            ...
            var6.addCrashSectionCallable("Item Type", new Callable<String>(this, var1) {
            ...
            var6.addCrashSectionCallable("Item Aux", new Callable<String>(this, var1) {
               private final ItemStack val$stack;
               final RenderItem this$0;
            ...
            var6.addCrashSectionCallable("Item NBT", new Callable<String>(this, var1) {
               final RenderItem this$0;
               private final ItemStack val$stack;
            ...
            var6.addCrashSectionCallable("Item Foil", new Callable<String>(this, var1) {
               final RenderItem this$0;
               private final ItemStack val$stack;
   ...
   protected void renderItemModelTransform(ItemStack var1, IBakedModel var2, ItemCameraTransforms.TransformType var3) {
      ...
      if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
         ...
         if (this.isThereOneNegativeScale(var4.getTransform(var3))) {
   ...
   private void renderModel(IBakedModel var1, int var2, ItemStack var3) {
      ...
      for(int var9 = 0; var9 < var10; ++var9) {
         ...
         this.renderQuads(var5, var1.getFaceQuads(var8), var2, var3);
      }
      ...
      if (var1 != null) {
         ...
         if (var2.isBuiltInRenderer()) {
            ...
            if (Config.isCustomItems()) {
               var2 = CustomItems.getCustomItemModel(var1, var2, (ResourceLocation)null, false);
            }
   ...
   private void renderQuads(WorldRenderer var1, List<BakedQuad> var2, int var3, ItemStack var4) {
   ...
   private void draw(WorldRenderer var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
   ...
   public void renderItemOverlayIntoGUI(FontRenderer var1, ItemStack var2, int var3, int var4, String var5) {
      if (var2 != null) {
         ...
         if (ReflectorForge.isItemDamaged(var2)) {
            int var14 = (int)Math.round(13.0D - (double)var2.getItemDamage() * 13.0D / (double)var2.getMaxDamage());
            int var7 = (int)Math.round(255.0D - (double)var2.getItemDamage() * 255.0D / (double)var2.getMaxDamage());
            if (Reflector.ForgeItem_getDurabilityForDisplay.exists()) {
               double var8 = Reflector.callDouble(var2.getItem(), Reflector.ForgeItem_getDurabilityForDisplay, var2);
               var14 = (int)Math.round(13.0D - var8 * 13.0D);
            ...
            WorldRenderer var9 = var15.getWorldRenderer();
            this.draw(var9, var3 + 2, var4 + 13, 13, 2, 0, 0, 0, 255);
            this.draw(var9, var3 + 2, var4 + 13, 12, 1, (255 - var7) / 4, 64, 0, 255);
            int var10 = 255 - var7;
            int var11 = var7;
            int var12 = 0;
            if (Config.isCustomColors()) {
               int var13 = CustomColors.getDurabilityColor(var7);
               if (var13 >= 0) {
                  var10 = var13 >> 16 & 255;
                  var11 = var13 >> 8 & 255;
                  var12 = var13 >> 0 & 255;
            ...
            this.draw(var9, var3 + 2, var4 + 13, var14, 1, var10, var11, var12, 255);
            GlStateManager.enableBlend();
      ...
      if (var1 != null && var2 != null) {
         ...
         if (var2 instanceof EntityPlayer) {
            ...
            if (var7 != null) {
               ...
               if (Config.isCustomItems()) {
                  var4 = CustomItems.getCustomItemModel(var1, var4, var7, true);
               }
            }
         }
