...
public class RenderManager {
   ...
   public void cacheActiveRenderInfo(World var1, FontRenderer var2, Entity var3, Entity var4, GameSettings var5, float var6) {
      ...
      if (var3 instanceof EntityLivingBase && ((EntityLivingBase)var3).isPlayerSleeping()) {
         ...
         if (Reflector.callBoolean(var8, Reflector.ForgeBlock_isBed, var7, var1, new BlockPos(var3), (EntityLivingBase)var3)) {
            EnumFacing var9 = (EnumFacing)Reflector.call(var8, Reflector.ForgeBlock_getBedDirection, var7, var1, new BlockPos(var3));
   ...
   private void renderDebugBoundingBox(Entity var1, double var2, double var4, double var6, float var8, float var9) {
      ...
      RenderGlobal.drawOutlinedBoundingBox(var12, 255, 255, 255, 255);
      if (var1 instanceof EntityLivingBase) {
         float var13 = 0.01F;
         RenderGlobal.drawOutlinedBoundingBox(new AxisAlignedBB(var2 - (double)var10, var4 + (double)var1.getEyeHeight() - 0.009999999776482582D, var6 - (double)var10, var2 + (double)var10, var4 + (double)var1.getEyeHeight() + 0.009999999776482582D, var6 + (double)var10), 255, 0, 0, 255);
      }
