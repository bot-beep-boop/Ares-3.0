...
public class RenderItemFrame extends Render<EntityItemFrame> {
   ...
   public static void updateItemRenderDistance() {
      ...
      double var1 = (double)Config.limit(var0.gameSettings.fovSetting, 1.0F, 120.0F);
      double var3 = Math.max(6.0D * (double)var0.displayHeight / var1, 16.0D);
      ...
      if (var2 != null) {
         ...
         if (!Reflector.postForgeBusEvent(Reflector.RenderItemInFrameEvent_Constructor, var1, this)) {
            if (var13 instanceof ItemMap) {
               ...
               MapData var15 = Items.filled_map.getMapData(var12.getEntityItem(), var1.worldObj);
