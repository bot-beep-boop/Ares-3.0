...
public class Stitcher {
   ...
   public List<TextureAtlasSprite> getStichSlots() {
      ...
      while(var3.hasNext()) {
         Stitcher.Slot var2 = (Stitcher.Slot)var3.next();
         var2.getAllStitchSlots(var1);
      }
      ...
      while(var4.hasNext()) {
         Stitcher.Slot var8 = (Stitcher.Slot)var4.next();
         Stitcher.Holder var5 = var8.getStitchHolder();
         TextureAtlasSprite var6 = var5.getAtlasSprite();
         var6.initSprite(this.currentWidth, this.currentHeight, var8.getOriginX(), var8.getOriginY(), var5.isRotated());
         var7.add(var6);
      }
         ...
         if (this.holder != null) {
            ...
            if (var2 <= this.width && var3 <= this.height) {
               if (var2 == this.width && var3 == this.height) {
                  ...
                  Iterator var9 = this.subSlots.iterator();

                  while(var9.hasNext()) {
                     Stitcher.Slot var8 = (Stitcher.Slot)var9.next();
                     if (var8.addSlot(var1)) {
                        return true;
                     }
                  }
