...
public class TextureUtil {
   ...
   public static int[][] generateMipmapData(int var0, int var1, int[][] var2) {
      ...
      if (var0 > 0) {
         ...
         int var5;
         for(var5 = 0; var5 < var2[0].length; ++var5) {
            if (var2[0][var5] >> 24 == 0) {
               var4 = true;
               break;
            }
            ...
            if (var2[var5] != null) {
               ...
               for(int var11 = 0; var11 < var8; ++var11) {
                  for(int var12 = 0; var12 < var9; ++var12) {
                     ...
                     var7[var11 + var12 * var8] = blendColors(var6[var13], var6[var13 + 1], var6[var13 + var10], var6[var13 + 1 + var10], var4);
                  }
               }
