...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   private void renderWorldPass(int var1, float var2, long var3) {
      ...
      double var12 = var11.lastTickPosX + (var11.posX - var11.lastTickPosX) * (double)var2;
      double var14 = var11.lastTickPosY + (var11.posY - var11.lastTickPosY) * (double)var2;
      double var16 = var11.lastTickPosZ + (var11.posZ - var11.lastTickPosZ) * (double)var2;
      if (var5) {
      ...
      if (var5) {
         ShadersRender.setupTerrain(var6, var11, (double)var2, var10, this.frameCount++, this.mc.thePlayer.isSpectator());
      } else {
         var6.setupTerrain(var11, (double)var2, var10, this.frameCount++, this.mc.thePlayer.isSpectator());
      }
      ...
      var6.renderBlockLayer(EnumWorldBlockLayer.SOLID, (double)var2, var1, var11);
      ...
      var6.renderBlockLayer(EnumWorldBlockLayer.CUTOUT_MIPPED, (double)var2, var1, var11);
      ...
      var6.renderBlockLayer(EnumWorldBlockLayer.CUTOUT, (double)var2, var1, var11);
      this.mc.getTextureManager().getTexture(TextureMap.locationBlocksTexture).restoreLastBlurMipmap();
      if (var5) {
      ...
      if (!this.debugView) {
         ...
         GlStateManager.popMatrix();
         GlStateManager.pushMatrix();
         if (this.mc.objectMouseOver != null && var11.isInsideOfMaterial(Material.water) && var8) {
      ...
      if (var8 && this.mc.objectMouseOver != null && !var11.isInsideOfMaterial(Material.water)) {
         ...
         GlStateManager.disableAlpha();
         this.mc.mcProfiler.endStartSection("outline");
         if ((!Reflector.ForgeHooksClient_onDrawBlockHighlight.exists() || !Reflector.callBoolean(Reflector.ForgeHooksClient_onDrawBlockHighlight, var6, var18, this.mc.objectMouseOver, 0, var18.getHeldItem(), var2)) && !this.mc.gameSettings.hideGUI) {
            var6.drawSelectionBox(var18, this.mc.objectMouseOver, 0, var2);
         }
      ...
      var6.renderBlockLayer(EnumWorldBlockLayer.TRANSLUCENT, (double)var2, var1, var11);
      if (var5) {
         Shaders.endWater();
      }
   ...
   private void updateFogColor(float var1) {
      ...
      Block var21 = ActiveRenderInfo.getBlockAtEntityViewpoint(this.mc.theWorld, var3, var1);
      Vec3 var22;
      if (this.cloudFog) {
         var22 = var2.getCloudColour(var1);
         ...
         var13 = Config.limit(var13, 0.0F, 0.6F);
         ...
         Vec3 var23 = CustomColors.getUnderwaterColor(this.mc.theWorld, this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().posY + 1.0D, this.mc.getRenderViewEntity().posZ);
         if (var23 != null) {
            this.fogColorRed = (float)var23.xCoord;
            this.fogColorGreen = (float)var23.yCoord;
            this.fogColorBlue = (float)var23.zCoord;
         }
      } else if (var21.getMaterial() == Material.lava) {
         this.fogColorRed = 0.6F;
         this.fogColorGreen = 0.1F;
         this.fogColorBlue = 0.0F;
         var22 = CustomColors.getUnderlavaColor(this.mc.theWorld, this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().posY + 1.0D, this.mc.getRenderViewEntity().posZ);
         if (var22 != null) {
            this.fogColorRed = (float)var22.xCoord;
            this.fogColorGreen = (float)var22.yCoord;
            this.fogColorBlue = (float)var22.zCoord;
      ...
      double var24 = (var3.lastTickPosY + (var3.posY - var3.lastTickPosY) * (double)var1) * var2.provider.getVoidFogYFactor();
      if (var3 instanceof EntityLivingBase && ((EntityLivingBase)var3).isPotionActive(Potion.blindness)) {
         ...
         if (var16 < 20) {
            var24 *= (double)(1.0F - (float)var16 / 20.0F);
         } else {
            var24 = 0.0D;
         }
      }
      ...
      if (var24 < 1.0D) {
         ...
         var24 *= var24;
         this.fogColorRed = (float)((double)this.fogColorRed * var24);
         this.fogColorGreen = (float)((double)this.fogColorGreen * var24);
         this.fogColorBlue = (float)((double)this.fogColorBlue * var24);
      }

      float var25;
      if (this.bossColorModifier > 0.0F) {
         var25 = this.bossColorModifierPrev + (this.bossColorModifier - this.bossColorModifierPrev) * var1;
      ...
      if (var3 instanceof EntityLivingBase && ((EntityLivingBase)var3).isPotionActive(Potion.nightVision)) {
         var25 = this.getNightVisionBrightness((EntityLivingBase)var3, var1);
         ...
         this.fogColorRed = this.fogColorRed * (1.0F - var25) + this.fogColorRed * var17 * var25;
         this.fogColorGreen = this.fogColorGreen * (1.0F - var25) + this.fogColorGreen * var17 * var25;
         this.fogColorBlue = this.fogColorBlue * (1.0F - var25) + this.fogColorBlue * var17 * var25;
      }
      ...
      if (Reflector.EntityViewRenderEvent_FogColors_Constructor.exists()) {
         Object var26 = Reflector.newInstance(Reflector.EntityViewRenderEvent_FogColors_Constructor, this, var3, var21, var1, this.fogColorRed, this.fogColorGreen, this.fogColorBlue);
         Reflector.postForgeBusEvent(var26);
         this.fogColorRed = Reflector.getFieldValueFloat(var26, Reflector.EntityViewRenderEvent_FogColors_red, this.fogColorRed);
         this.fogColorGreen = Reflector.getFieldValueFloat(var26, Reflector.EntityViewRenderEvent_FogColors_green, this.fogColorGreen);
         this.fogColorBlue = Reflector.getFieldValueFloat(var26, Reflector.EntityViewRenderEvent_FogColors_blue, this.fogColorBlue);
      }
   ...
   private void setupFog(int var1, float var2) {
      ...
      if (var6 >= 0.0F) {
         ...
         if (var3 instanceof EntityLivingBase && ((EntityLivingBase)var3).isPotionActive(Potion.blindness)) {
            var7 = 5.0F;
            int var9 = ((EntityLivingBase)var3).getActivePotionEffect(Potion.blindness).getDuration();
            if (var9 < 20) {
               var7 = 5.0F + (this.farPlaneDistance - 5.0F) * (1.0F - (float)var9 / 20.0F);
            }
            ...
            GlStateManager.setFog(2048);
            var7 = Config.isClearWater() ? 0.02F : 0.1F;
            if (var3 instanceof EntityLivingBase && ((EntityLivingBase)var3).isPotionActive(Potion.waterBreathing)) {
               GlStateManager.setFogDensity(0.01F);
            } else {
               float var8 = 0.1F - (float)EnchantmentHelper.getRespiration(var3) * 0.03F;
   ...
   public void getMouseOver(float var1) {
      ...
      if (var2 != null && this.mc.theWorld != null) {
         ...
         Vec3 var12 = null;
         float var13 = 1.0F;
         List var14 = this.mc.theWorld.getEntitiesInAABBexcluding(var2, var2.getEntityBoundingBox().addCoord(var10.xCoord * var3, var10.yCoord * var3, var10.zCoord * var3).expand((double)var13, (double)var13, (double)var13), Predicates.and(EntitySelectors.NOT_SPECTATING, new Predicate<Entity>(this) {
         ...
         for(int var17 = 0; var17 < var14.size(); ++var17) {
            ...
            if (var20.isVecInside(var7)) {
               ...
               if (var22 < var15 || var15 == 0.0D) {
                  ...
                  if (!var24 && var18 == var2.ridingEntity) {
                     if (var15 == 0.0D) {
                        this.pointedEntity = var18;
                        var12 = var21.hitVec;
                     }
   ...
   public void updateCameraAndRender(float var1, long var2) {
      ...
      if (this.mc.inGameHasFocus && var4) {
         ...
         if (this.mc.gameSettings.smoothCamera) {
            ...
            this.mc.thePlayer.setAngles(var7, var8 * (float)var9);
         } else {
      ...
      if (!this.mc.skipRenderWorld) {
         ...
         if (this.mc.currentScreen != null) {
            ...
            try {
               ...
               var13.addCrashSectionCallable("Screen name", new Callable<String>(this) {
                  final EntityRenderer this$0;
               ...
               var13.addCrashSectionCallable("Mouse location", new Callable<String>(this, var20, var21) {
               ...
               var13.addCrashSectionCallable("Screen size", new Callable<String>(this, var17) {
                  final EntityRenderer this$0;
                  ...
                  public String call() throws Exception {
                     return String.format("Scaled: (%d, %d). Absolute: (%d, %d). Scale factor of %d", this.val$scaledresolution.getScaledWidth(), this.val$scaledresolution.getScaledHeight(), EntityRenderer.access$0(this.this$0).displayWidth, EntityRenderer.access$0(this.this$0).displayHeight, this.val$scaledresolution.getScaleFactor());
                  }
   ...
   protected void renderRainSnow(float var1) {
      ...
      float var49 = this.mc.theWorld.getRainStrength(var1);
      if (var49 > 0.0F) {
         if (Config.isRainOff()) {
            return;
         }
   ...
   private void updateLightmap(float var1) {
      if (this.lightmapUpdateNeeded) {
         ...
         WorldClient var2 = this.mc.theWorld;
         if (var2 != null) {
            if (Config.isCustomColors() && CustomColors.updateLightmap(var2, this.torchFlickerX, this.lightmapColors, this.mc.thePlayer.isPotionActive(Potion.nightVision), var1)) {
            ...
            for(int var5 = 0; var5 < 256; ++var5) {
               ...
               if (this.mc.thePlayer.isPotionActive(Potion.nightVision)) {
                  var15 = this.getNightVisionBrightness(this.mc.thePlayer, var1);
                  var16 = 1.0F / var12;
                  if (var16 > 1.0F / var13) {
                     var16 = 1.0F / var13;
                  }
   ...
   private void checkLoadVisibleChunks(Entity var1, float var2, ICamera var3, boolean var4) {
      ...
      if (this.loadVisibleChunks) {
         ...
         this.loadAllVisibleChunks(var1, (double)var2, var3, var4);
      ...
      if (var2 instanceof EntityLivingBase && ((EntityLivingBase)var2).isPlayerSleeping()) {
         ...
         if (!this.mc.gameSettings.debugCamEnable) {
            ...
            if (Reflector.ForgeHooksClient_orientBedCamera.exists()) {
               Reflector.callVoid(Reflector.ForgeHooksClient_orientBedCamera, this.mc.theWorld, var27, var11, var2);
            } else if (var30 == Blocks.bed) {
               int var32 = ((EnumFacing)var11.getValue(BlockBed.FACING)).getHorizontalIndex();
               GlStateManager.rotate((float)(var32 * 90), 0.0F, 1.0F, 0.0F);
            }
      ...
      if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists()) {
         if (!this.mc.gameSettings.debugCamEnable) {
            ...
            if (var2 instanceof EntityAnimal) {
               ...
               var28 = var33.prevRotationYawHead + (var33.rotationYawHead - var33.prevRotationYawHead) * var1 + 180.0F;
            }

            Block var35 = ActiveRenderInfo.getBlockAtEntityViewpoint(this.mc.theWorld, var2, var1);
            Object var34 = Reflector.newInstance(Reflector.EntityViewRenderEvent_CameraSetup_Constructor, this, var2, var35, var1, var28, var29, var12);
            Reflector.postForgeBusEvent(var34);
            var12 = Reflector.getFieldValueFloat(var34, Reflector.EntityViewRenderEvent_CameraSetup_roll, var12);
            var29 = Reflector.getFieldValueFloat(var34, Reflector.EntityViewRenderEvent_CameraSetup_pitch, var29);
            var28 = Reflector.getFieldValueFloat(var34, Reflector.EntityViewRenderEvent_CameraSetup_yaw, var28);
   ...
   private float getFOVModifier(float var1, boolean var2) {
      ...
      if (ConfigManager.settings.ZoomAnimation == 1) {
         if (this.debugView) {
            ...
            var3 = this.mc.getRenderViewEntity();
            var4 = 70.0F;
            if (var2) {
            ...
            if (var3 instanceof EntityLivingBase && ((EntityLivingBase)var3).getHealth() <= 0.0F) {
               var7 = (float)((EntityLivingBase)var3).deathTime + var1;
               var4 /= (1.0F - 500.0F / (var7 + 500.0F)) * 2.0F + 1.0F;
            }

            var8 = ActiveRenderInfo.getBlockAtEntityViewpoint(this.mc.theWorld, var3, var1);
            if (var8.getMaterial() == Material.water) {
               var4 = var4 * 60.0F / 70.0F;
            }

            return Reflector.ForgeHooksClient_getFOVModifier.exists() ? Reflector.callFloat(Reflector.ForgeHooksClient_getFOVModifier, this, var3, var8, var1, var4) : var4;
         }
   ...
   public void updateRenderer() {
      ...
      float var8 = this.mc.theWorld.getLightBrightness(new BlockPos(var12, var4, var6));
