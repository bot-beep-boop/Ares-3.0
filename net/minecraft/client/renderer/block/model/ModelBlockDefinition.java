...
public class ModelBlockDefinition {
   ...
   public class MissingVariantException extends RuntimeException {
      ...
      protected MissingVariantException(ModelBlockDefinition var1) {
         this.this$0 = var1;
      }
   }
   ...
   public static class Deserializer implements JsonDeserializer<ModelBlockDefinition> {
      ...
      protected ModelBlockDefinition.Variants parseVariants(JsonDeserializationContext var1, Entry<String, JsonElement> var2) {
      ...
      protected List<ModelBlockDefinition.Variants> parseVariantsList(JsonDeserializationContext var1, JsonObject var2) {
