   ...
   public void unlockAchievement(EntityPlayer var1, StatBase var2, int var3) {
      ...
      if (var2.isAchievement() && var4 == 0 && var3 > 0) {
         ...
         if (this.mcServer.isAnnouncingPlayerAchievements()) {
            this.mcServer.getConfigurationManager().sendChatMsg(new ChatComponentTranslation("chat.type.achievement", new Object[]{var1.getDisplayName(), var2.createChatComponent()}));
         }
      }
      ...
      if (var2.isAchievement() && var4 > 0 && var3 == 0) {
         this.field_150886_g = true;
         if (this.mcServer.isAnnouncingPlayerAchievements()) {
            this.mcServer.getConfigurationManager().sendChatMsg(new ChatComponentTranslation("chat.type.achievement.taken", new Object[]{var1.getDisplayName(), var2.createChatComponent()}));
         }
      }
   ...
   public static String dumpJson(Map<StatBase, TupleIntJsonSerializable> var0) {
      ...
      while(var3.hasNext()) {
         ...
         if (((TupleIntJsonSerializable)var2.getValue()).getJsonSerializableValue() != null) {
            ...
            var4.addProperty("value", ((TupleIntJsonSerializable)var2.getValue()).getIntegerValue());
            ...
            var1.addProperty(((StatBase)var2.getKey()).statId, ((TupleIntJsonSerializable)var2.getValue()).getIntegerValue());
         }
      }
