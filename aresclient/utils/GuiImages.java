...
public class GuiImages {
   ...
   public static void drawPictureWithTextureOffset(int var0, int var1, int var2, int var3, int var4, int var5, String var6) {
      ResourceLocation var7 = new ResourceLocation(var6);
      mc.getTextureManager().bindTexture(var7);
      Gui.drawTexturedModalRect(var0, var1, var2, var3, var4, var5);
   }
