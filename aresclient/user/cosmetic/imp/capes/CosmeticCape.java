...
import com.aresclient.user.cosmetic.imp.capes.particle.CapeParticleRenderer;
...
public class CosmeticCape implements LayerRenderer<AbstractClientPlayer> {
   private CapeParticleRenderer part;
   ...
   public CosmeticCape(RenderPlayer var1) {
      this.playerRenderer = var1;
      this.part = new CapeParticleRenderer();
   }
   ...
   public void doRenderLayer(AbstractClientPlayer var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      if (var1.hasPlayerInfo() && !var1.isInvisible() && ConfigManager.settings.capemode.equals("ares") && var1.getLocationAresCape() != null) {
         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
         this.playerRenderer.bindTexture(var1.getLocationAresCape());
