...
public class OptifineCape implements LayerRenderer<AbstractClientPlayer> {
   ...
   public void doRenderLayer(AbstractClientPlayer var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      if (var1.hasPlayerInfo() && !var1.isInvisible() && ConfigManager.settings.capemode.equals("optifine") && var1.getLocationOptifineCape() != null) {
         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
         this.playerRenderer.bindTexture(var1.getLocationOptifineCape());
   ...
   public OptifineCape(RenderPlayer var1) {
