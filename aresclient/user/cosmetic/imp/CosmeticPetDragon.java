...
public class CosmeticPetDragon extends Cosmetic {
   CosmeticPetDragon.BlazeModel blazemodel;
   ...
   public CosmeticPetDragon(RenderPlayer var1) {
      super(var1);
      this.blazemodel = new CosmeticPetDragon.BlazeModel(var1);
   }
   ...
   static class BlazeModel extends ModelBase {
      ...
      public void render(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
         ...
         for(int var19 = 0; var19 < 5; ++var19) {
            ...
            var21 = (float)Math.cos((double)((float)var19 * 0.45F + var17)) * 0.15F;
            ...
            this.spine.rotateAngleZ = -this.updateRotations(var20[0] - (double)var16) * 3.1415927F / 180.0F * var13;
         ...
         this.head.rotateAngleZ = -this.updateRotations(var22[0] - (double)var16) * 3.1415927F / 180.0F * 1.0F;
         ...
         for(int var25 = 0; var25 < 12; ++var25) {
            ...
            var24 = (float)((double)var24 + Math.sin((double)((float)var25 * 0.45F + var17)) * 0.05000000074505806D);
            ...
            this.spine.rotateAngleZ = this.updateRotations(var22[0] - (double)var16) * 3.1415927F / 180.0F * var13;
            this.spine.rotationPointY = var11;
            this.spine.rotationPointZ = var18;
            this.spine.rotationPointX = var12;
            var11 = (float)((double)var11 + Math.sin((double)this.spine.rotateAngleX) * 10.0D);
