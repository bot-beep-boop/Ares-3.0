...
public class GuiCapes extends GuiScreen {
   ...
   private void updatebuttons() {
      ...
      this.buttonList.add(new ImageButton(1, 10, var2 - var1 * 1, var1, var1, new ResourceLocation("Ares/Capes/anime/buttons/cape1.png")));
      this.buttonList.add(new ImageButton(2, 10, var2, var1, var1, new ResourceLocation("Ares/Capes/anime/buttons/cape2.png")));
      this.buttonList.add(new ImageButton(3, 10, var2 + var1 * 1, var1, var1, new ResourceLocation("Ares/Capes/anime/buttons/cape3.png")));
      this.buttonList.add(new ImageButton(7, 10, var2 + var1 * 2, var1, var1, new ResourceLocation("Ares/Capes/anime/buttons/cape7.png")));
      this.buttonList.add(new ImageButton(4, 20 + var1, var2 - var1 * 1, var1, var1, new ResourceLocation("Ares/Capes/anime/buttons/cape4.png")));
      this.buttonList.add(new ImageButton(5, 20 + var1, var2, var1, var1, new ResourceLocation("Ares/Capes/anime/buttons/cape5.png")));
      this.buttonList.add(new ImageButton(6, 20 + var1, var2 + var1 * 1, var1, var1, new ResourceLocation("Ares/Capes/anime/buttons/cape6.png")));
      int var3 = width / 2 + width / 3 - var1 / 2;
      int var4 = height / 2 + height / 6 + var1 / 2;
      this.buttonList.add(new ImageButtonWithText(25, var3 - var1 - 5, var4, var1, var1, new ResourceLocation("Ares/Icons/Capes/Capetype" + ConfigManager.settings.capemode + ".png"), "Cape Type", I18n.format("ares.cosmetic.capes.capetype")));
   ...
   protected void actionPerformed(GuiButton var1) throws IOException {
      if (var1.id == 25) {
         String var2;
         switch((var2 = ConfigManager.settings.capemode).hashCode()) {
         case -1548612125:
            if (var2.equals("offline")) {
