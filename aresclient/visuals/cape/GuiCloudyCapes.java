...
public class GuiCloudyCapes extends GuiScreen {
   ...
   private void updatebuttons() {
      ...
      this.buttonList.add(new ImageButton(1, 10, var2 - var1 * 1, var1, var1, new ResourceLocation("Ares/Capes/cloudy/buttons/cape1.png")));
      this.buttonList.add(new ImageButton(2, 10, var2, var1, var1, new ResourceLocation("Ares/Capes/cloudy/buttons/cape2.png")));
      this.buttonList.add(new ImageButton(3, 10, var2 + var1 * 1, var1, var1, new ResourceLocation("Ares/Capes/cloudy/buttons/cape3.png")));
      this.buttonList.add(new ImageButton(4, 20 + var1, var2 - var1 * 1, var1, var1, new ResourceLocation("Ares/Capes/cloudy/buttons/cape4.png")));
      this.buttonList.add(new ImageButton(5, 20 + var1, var2, var1, var1, new ResourceLocation("Ares/Capes/cloudy/buttons/cape5.png")));
      this.buttonList.add(new ImageButton(6, 20 + var1, var2 + var1 * 1, var1, var1, new ResourceLocation("Ares/Capes/cloudy/buttons/cape6.png")));
