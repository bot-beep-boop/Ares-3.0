...
public class GuiCheckBoxAres extends GuiButton {
   private static Color color;
   public boolean state = false;

   public GuiCheckBoxAres(int var1, int var2, int var3) {
   ...
   public boolean mousePressed(Minecraft var1, int var2, int var3) {
      return this.enabled && this.visible && var2 >= this.xPosition && var3 >= this.yPosition && var2 < this.xPosition + 50 && var3 < this.yPosition + this.height + 50;
   }
   ...
   public void drawButton(Minecraft var1, int var2, int var3) {
      if (this.state) {
         drawTexture(new ResourceLocation("Ares/Icons/Toggles/true.png"), (float)this.xPosition, (float)this.yPosition, 50.0F, 50.0F);
      } else {
         drawTexture(new ResourceLocation("Ares/Icons/Toggles/false.png"), (float)this.xPosition, (float)this.yPosition, 50.0F, 50.0F);
      }
