...
public class GuiCustomizeWings extends GuiScreen {
   ...
   protected void actionPerformed(GuiButton var1) throws IOException {
      ...
      if (var1.id == 16) {
         this.mc.displayGuiScreen(new GuiCustomizeBunnyEars());
      }
   ...
   private void updatebuttons() {
      ...
      this.buttonList.add(new ImageButton(1, 10, var2 - var1 * 1, var1, var1, new ResourceLocation("Ares/cosmetic/wings/button1.png")));
      this.buttonList.add(new ImageButton(2, 10, var2, var1, var1, new ResourceLocation("Ares/cosmetic/wings/button2.png")));
      this.buttonList.add(new ImageButton(3, 10, var2 + var1 * 1, var1, var1, new ResourceLocation("Ares/cosmetic/wings/button3.png")));
      this.buttonList.add(new ImageButton(7, 10, var2 + var1 * 2, var1, var1, new ResourceLocation("Ares/cosmetic/wings/button7.png")));
      this.buttonList.add(new ImageButton(4, 20 + var1, var2 - var1 * 1, var1, var1, new ResourceLocation("Ares/cosmetic/wings/button4.png")));
      this.buttonList.add(new ImageButton(5, 20 + var1, var2, var1, var1, new ResourceLocation("Ares/cosmetic/wings/button5.png")));
      this.buttonList.add(new ImageButton(6, 20 + var1, var2 + var1 * 1, var1, var1, new ResourceLocation("Ares/cosmetic/wings/button6.png")));
